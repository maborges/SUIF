...
<?php
	...
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/config_geral.php' >&#8226; Geral</a></div>";

	echo "
	<div style='float:left; width:20px; height:15px; border:0px solid #000'></div>
	<div class='link_4' style='float:left; width:auto; height:18px; border:0px solid #000'>
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/cadastro_sacaria.php' >&#8226; Cadastro de Sacaria</a></div>";

	echo "
	<div style='float:left; width:20px; height:15px; border:0px solid #000'></div>
	<div class='link_4' style='float:left; width:auto; height:18px; border:0px solid #000'>
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/cadastro_un_medida.php' >&#8226; Unidade de Medida</a></div>";

	echo "
	<div style='float:left; width:20px; height:15px; border:0px solid #000'></div>
	<div class='link_4' style='float:left; width:auto; height:18px; border:0px solid #000'>
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/cadastro_forma_entrega.php' >&#8226; Forma de Entrega</a></div>";

	echo "
	<div style='float:left; width:20px; height:15px; border:0px solid #000'></div>
	<div class='link_4' style='float:left; width:auto; height:18px; border:0px solid #000'>
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/cadastro_armazem.php' >&#8226; Cadastro de Armaz&eacute;m</a></div>";

	echo "
	<div style='float:left; width:20px; height:15px; border:0px solid #000'></div>
	<div class='link_4' style='float:left; width:auto; height:18px; border:0px solid #000'>
	<a href='$servidor/$diretorio_servidor/cadastros/configuracoes/cadastro_lote.php' >&#8226; Cadastro de Lote</a></div>";
