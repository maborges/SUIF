...
<td width='120px' align='center' bgcolor='#006699'>Tipo</td>
<td width='100px' align='center' bgcolor='#006699'>Quantidade</td>
<td width='100px' align='center' bgcolor='#006699'>Pre&ccedil;o Un</td>
<td width='120px' align='center' bgcolor='#006699'>Valor Total</td>
</tr>
</table>";}
...
// ====== RELATORIO ========================================================================================
	...
	<td width='120px' align='center'><div style='margin-left:0px'>$produto_print_2</div></td>
	<td width='120px' align='center'><div style='margin-left:0px'>$tipo</div></td>
	<td width='100px' align='center'><div style='margin-left:0px'>$quantidade_print $unidade_print</div></td>
	<td width='100px' align='right'><div style='margin-right:3px'>$preco_unitario_print</div></td>
	<td width='120px' align='right'><div style='margin-right:3px'>$valor_total_print</div></td>";
/*	
	if ($permissao[65] == 'S')
		{echo "
