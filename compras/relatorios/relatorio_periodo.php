...
$pagina_mae = empty($_POST["pagina_mae"]) ? '' : $_POST["pagina_mae"];
...
<body onload="javascript:foco('ok');">
	...
	<div class="ct_auto">
		...
		<div class="pqa">
			...
			<!-- ================================================================================================================ -->
			<div class="pqa_caixa">
				<form action="<?php echo "$servidor/$diretorio_servidor"; ?>/compras/relatorios/relatorio_periodo.php" method="post" />
		...
		for ($x = 1; $x <= $linha_compra; $x++) {
			...
			$idPedidoSankhya_w = $aux_compra[25];
			...
			echo "
				...
				<input type='hidden' name='idPedidoSankhya' value='$idPedidoSankhya_w'>
				<input type='hidden' name='data_inicial_busca' value='$data_inicial_br'>
				<input type='hidden' name='data_final_busca' value='$data_final_br'>
				<input type='hidden' name='fornecedor_pesquisa' value='$fornecedor_pesquisa'>
				<input type='hidden' name='nome_fornecedor' value='$nome_fornecedor'>
			...
			echo "
				...
				<td width='340px' align='left'><div style='height:14px; margin-left:10px; overflow:hidden'>$fornecedor_print_w</div></td>
				<td width='100px' align='center'>$numero_compra_w</td>
				<td width='100px' align='center'>$idPedidoSankhya_w</td>
