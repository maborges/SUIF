...
include ("../../helpers.php");
$pagina = "relatorio_usuario_impressao";
...
if (empty($usuario_busca) or $usuario_busca == "GERAL")
	{$mysql_usuario = "compras.usuario_cadastro IS NOT NULL";
	$usuario_busca = "GERAL";}
else
	{$mysql_usuario = "compras.usuario_cadastro='$usuario_busca'";
	$usuario_busca = $usuario_busca;
	$usuario_busca_print = " | Usu&aacute;rio: <b>" . $usuario_busca . "</b>";}
