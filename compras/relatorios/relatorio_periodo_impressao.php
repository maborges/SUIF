...
// Variáveis utilizadas no programa e não definidas ou lidas dos parâmetros
$contador_vazio = $_POST["contador_vazio"] ?? 0;
$sc  = $_POST["sc"] ?? 0;
// ================================================================================================================
...
$soma_compra = mysqli_fetch_row(mysqli_query(
	$conexao,
	"SELECT
	SUM(valor_total)
FROM
...
if ($soma_compra[0] > 0) {
	$soma_compra_print = number_format($soma_compra[0], 2, ",", ".");
}
// ================================================================================================================
...
<body onLoad="imprimir()">
	...
	<div style="width:858px; border:0px solid #F00">
		...
		for ($x_principal = 1; $x_principal <= $numero_paginas; $x_principal++) {
			...
			echo "
				<div style='width:858px; height:1080px; border:0px solid #000; page-break-after:always; margin: 30px;'>




				<!-- =================================================================================================================== -->
				<div style='width:845px; height:90px; border:0px solid #D85; float:left; font-size:17px' align='center'>
				...
				<!-- =================================================================================================================== -->
				<div style='width:845px; height:auto; border:0px solid #00E; margin-top:2px; margin-left:10px; float:left'>

				<div style='width:840px; border:0px solid #000; margin-top:1px; float:left; color:#FFF; font-size:9px; text-align:center'>
					...
					<div style='width:80px; height:20px; border:1px solid #000; float:left; background-color:#666; margin-left:2px'><div style='margin-top:4px'>Sankhya</div></div>
				</div>";
			...
			for ($x = 1; $x <= $limite_registros; $x++) {
				...
				if (empty($id_w)) {
					...
					echo "
						<div style='width:840px; height:17px; border:1px solid #FFF; margin-top:4px; float:left; color:#000; font-size:10px'>
							...
							<div style='width:80px; height:15px; border:1px solid #FFF; float:left; text-align:right; background-color:#FFF; margin-left:2px'>
							<div style='height:11px; margin-right:5px; overflow:hidden; margin-top:2px'>$total_geral_print</div>
							</div>
							
							<div style='width:80px; height:15px; border:1px solid #FFF; float:left; text-align:center; background-color:#FFF; margin-left:2px'>
							<div style='height:11px; margin-right:5px; overflow:hidden; margin-top:2px'>$idSankhya_w</div>
							</div>
						</div>";
				}
				// ======================================================================================================
			...
			if ($x_principal == $numero_paginas and $vazio >= 1) {
				for ($v = 1; $v <= $vazio; $v++) {
					if ($v == 1) {
						echo "<div style='width:800px; height:17px; border:1px solid #FFF; margin-top:4px; float:left; color:#000; font-size:10px'>
						...
						for ($sc = 1; $sc <= $linha_produto_distinct; $sc++) {
							...
							$soma_total_print = number_format($soma_total_geral, 2, ",", ".");
							$soma_quantidade_print = number_format($soma_quantidade_geral, 2, ",", ".") . " $unidade_print_t";

							echo "
								<div style='width:800px; height:17px; border:1px solid #000; margin-top:4px; float:left; color:#000; font-size:10px'>
								
									<div style='width:150px; height:15px; border:0px solid #000; float:left; text-align:left; background-color:#FFF; margin-left:2px'>
										<div style='width:auto; height:11px; margin-left:5px; margin-top:2px; float:left'><b>$produto_print_t</b></div>
									</div>
						
									<div style='width:180px; height:15px; border:0px solid #000; float:left; text-align:left; background-color:#FFF; margin-left:20px'>
										<div style='width:auto; height:11px; margin-left:5px; margin-top:2px; float:left'>QUANTIDADE: $soma_quantidade_print</div>
									</div>
						
									<div style='width:150px; height:15px; border:0px solid #000; float:left; text-align:left; background-color:#FFF; margin-left:20px'>
										<div style='width:auto; height:11px; margin-left:5px; margin-top:2px; float:left'>PRE&Ccedil;O M&Eacute;DIO: $media_produto_print</div>
									</div>
						
									<div style='width:180px; height:15px; border:0px solid #000; float:left; text-align:left; background-color:#FFF; margin-left:20px'>
										<div style='width:auto; height:11px; margin-left:5px; margin-top:2px; float:left'>VALOR TOTAL: $soma_total_print</div>
									</div>
								</div>";
						}
					} elseif ($v == 3) {
						echo "
							<div style='width:800px; height:17px; border:1px solid #FFF; margin-top:4px; float:left; color:#000; font-size:10px'>
								...
								<div style='width:180px; height:15px; border:0px solid #000; float:left; text-align:left; background-color:#FFF; margin-left:20px'>
									<div style='width:auto; height:11px; margin-left:5px; margin-top:2px; float:left'>TOTAL GERAL: <b>$soma_compra_print</b></div>
								</div>
							</div>";
					} else {
						echo "<div style='width:800px; height:17px; border:1px solid #FFF; margin-top:4px; float:left; color:#000; font-size:10px'></div>";
					}
				}
			}
			// ========================================================================================================
			...
			echo "
				<!-- =============================================================================================== -->
				<div style='width:820px; height:10px; border:0px solid #000; margin-left:10px; margin-top:20px; float:left' align='center'>
				<div style='width:820px; height:5px; border-bottom:2px solid #999; margin-left:0px; float:left'></div>
				</div>


				<!-- =============================================================================================== -->
				<div style='width:820px; height:15px; border:0px solid #f85; float:left; margin-left:10px; font-size:17px' align='center'>
