...
<!-- ================================================================================================================ -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/relatorios/relatorio_usuario.php" method="post" />
...
<div style="width:auto; height:30px; border:1px solid transparent; margin-top:6px; float:left">
	...
	<form action='$servidor/$diretorio_servidor/compras/relatorios/relatorio_usuario_impressao.php' target='_blank' method='post' />
...
<td width='200px'>Usu&aacute;rio</td>
</tr>
</table>";}
...
<td width='200px' align='left'><div style='height:14px; margin-left:10px; overflow:hidden'>$usuario_cadastro_w</div></td>";
// =================================================================================================================
