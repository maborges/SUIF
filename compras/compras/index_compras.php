...
$status_busca = "ATIVO";
$filial_busca = $botao == "BUSCAR" ? $_POST["filial_busca"] : $filial_usuario;
$msg = '';

$data_inicial_br    = $_POST["data_inicial_busca"] ?? $data_hoje_br;
$data_inicial_busca = $_POST["data_inicial_busca"] ?? $data_hoje;
$data_final_br      = $_POST["data_final_busca"]   ?? $data_hoje_br;
$data_final_busca   = $_POST["data_final_busca"]   ?? $data_hoje;
