...
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/compras/cadastro_2_selec_fornecedor.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/compras/compras/cadastro_3_formulario.php' method='post'>
