<?php
	...
	$pagina = 'relatorio_fornecedor_impressao';
	$menu = 'contratos';
...
// ======== BUSCA CONTRATOS ====================================================================================================
	...
	AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' ORDER BY vencimento, nome_produtor");
	...
	{	
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND filial='$filial' 
	AND situacao_contrato='EM_ABERTO' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
	...
	{
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND filial='$filial' 
	AND situacao_contrato='PAGO' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
	...
	AND filial='$filial' AND produtor='$fornecedor' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
// =======================================================================================================
}
...
// ======== BUSCA CONTRATOS ====================================================================================================
	...
	{	
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND filial='$filial' 
	AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' AND cod_produto='$cod_produto' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
	...
	{	
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND filial='$filial' 
	AND situacao_contrato='EM_ABERTO' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' AND cod_produto='$cod_produto' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
	...
	{
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND filial='$filial' 
	AND situacao_contrato='PAGO' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND produtor='$fornecedor' AND cod_produto='$cod_produto' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
	...
	{
	$busca_cont_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND situacao_contrato='EM_ABERTO' 
	AND filial='$filial' AND produtor='$fornecedor' AND cod_produto='$cod_produto' ORDER BY vencimento, nome_produtor");
	$linha_cont_futuro = mysqli_num_rows ($busca_cont_futuro);
	}
// =======================================================================================================
}
...
<div id='centro' style='width:720px; height:62px; border:0px solid #D85; float:left; margin-top:10px; margin-left:10px; font-size:17px' align='center'>
	...
	echo "
	<div id='centro' style='width:430px; height:18px; border:0px solid #000; font-size:12px; float:left' align='center'><b>$fornecedor_print</b></div>
...
$aux_bp_geral = mysqli_fetch_row($busca_produto_geral);
	...
	AND filial='$filial' AND produto='$aux_bp_geral[20]' AND produtor='$fornecedor' AND vencimento>='$data_inicial' AND vencimento<='$data_final'"));
	$soma_futuros_print = number_format($soma_futuros[0],2,",",".");}

	elseif ($monstra_situacao == "aberto")
	{$soma_futuros = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade_a_entregar) FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' 
	AND filial='$filial' AND produto='$aux_bp_geral[20]' AND produtor='$fornecedor' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND situacao_contrato='EM_ABERTO'"));
	$soma_futuros_print = number_format($soma_futuros[0],2,",",".");}
	
	elseif ($monstra_situacao == "pagos")
	{$soma_futuros = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade_a_entregar) FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' 
	AND filial='$filial' AND produto='$aux_bp_geral[20]' AND produtor='$fornecedor' AND vencimento>='$data_inicial' AND vencimento<='$data_final' AND situacao_contrato='PAGO'"));
	$soma_futuros_print = number_format($soma_futuros[0],2,",",".");}
