...
$pagina = "contrato_futuro_seleciona";
...
<form name="popup" action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_futuro/contrato_futuro_cadastro.php" method="post">
...
<button type='submit' class='botao_2' style='margin-left:20px; width:120px'>Confirmar</button>
</form>
</div>
