...
$pagina = "index_contrato_futuro";
$titulo = "Contratos Futuros";
$modulo = "compras";
$menu = "contratos";
// ================================================================================================================
...
<!-- ====== CENTRO ================================================================================================= -->
<!-- INÍCIO CENTRO GERAL -->
<div id="centro_geral_relatorio" style="width:1280px; height:auto; margin:auto; background-color:#FFF; border-radius:10px; border:0px solid #999">
...
<div id="centro" style="height:36px; width:1250px; border:1px solid #999; margin:auto; background-color:#EEE">
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_futuro/index_contrato_futuro.php" method="post" />
...
<div id="centro" style="height:26px; width:1250px; border:0px solid #000; margin:auto">
	<div id="centro" style="width:400px; float:left; height:26px; margin-left:10px; border:0px solid #999">
		...
		<button type='submit' class='botao_2' style='margin-left:20px; width:120px'>Novo</button>
		</a>
	</div>
	...
	<div id="centro" style="width:400px; float:left; height:26px; border:0px solid #999; font-size:11px; color:#666; text-align:center">
        ...
        <button type='submit' class='botao_2' style='margin-left:20px; width:120px'>Imprimir</button></form>";}
        else
        {}
        ?>
	</div>
