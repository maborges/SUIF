...
<div style="width:1100px; height:20px; border:0px solid #000; margin:auto">
	...
	<?php 
		if ($fornecedor_form == "" or $linhas_forne == 0)
		{echo"<div id='centro' style='height:28px; width:120px; border:0px solid #000; color:#F00; font-size:14px; float:left'>
		<a href='$servidor/$diretorio_servidor/compras/contrato_futuro/relatorio_fornecedor_seleciona.php'>
		...
		{echo"<div id='centro' style='height:28px; width:750px; border:0px solid #000; color:#003466; font-size:14px; float:left'><i>Fornecedor: <b> $forne_print</b></i></div>";}
	?>
    </div>
</div>
...
<div id="centro" style="height:36px; width:1250px; border:1px solid #999; margin:auto; background-color:#EEE">
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_futuro/relatorio_fornecedor.php" method="post" />
