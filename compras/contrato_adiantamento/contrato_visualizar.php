...
{$erro = 2;
$msg = "<div style='color:#FF0000'>CONTRATO EXCLU&Iacute;DO</div>";}
...
echo "
<div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form action='$servidor/$diretorio_servidor/compras/contrato_adiantamento/contrato_excluir_confirmar.php' method='post'>
