...
$pagina = "contrato_excluir_confirmar";
...
// ====== CRIA MENSAGEM ============================================================================================
if ($linha_contrato == 0 or $numero_contrato == "")
{$erro = 1;
$msg = "<div style='color:#FF0000'>CONTRATO N&Atilde;O LOCALIZADO</div>";}

elseif ($permissao[144] != "S")
{$erro = 2;
$msg = "<div style='color:#FF0000'>Usu&aacute;rio sem autoriza&ccedil;&atilde;o para excluir Contrato de Adiantamento.</div>";}

elseif ($estado_registro_w == "EXCLUIDO")
{$erro = 3;
$msg = "<div style='color:#FF0000'>CONTRATO J&Aacute; EXCLU&Iacute;DO</div>";}

else
{$erro = 0;
$msg = "<div style='color:#FF0000'>Deseja realmente excluir este contrato?</div>";}
// ==================================================================================================================
...
<div style="width:510px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
    ...
    <div style='width:500px; height:25px; float:left; border:1px solid transparent'>
    <form action='$servidor/$diretorio_servidor/compras/contrato_adiantamento/contrato_excluir_enviar.php' method='post'>
