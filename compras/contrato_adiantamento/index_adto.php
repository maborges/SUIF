...
$mysql_filtro_data = "data_contrato BETWEEN '$data_inicial_busca' AND '$data_final_busca'";


if ($fornecedor_pesquisa == "" or $fornecedor_pesquisa == "GERAL")
	{$mysql_fornecedor = "cod_fornecedor IS NOT NULL";
	$fornecedor_pesquisa = "GERAL";}
else
	{$mysql_fornecedor = "cod_fornecedor='$fornecedor_pesquisa'";
...
// ====== BUSCA CADASTROS =========================================================================================
$busca_contrato = mysqli_query ($conexao, "SELECT * FROM contrato_adiantamento WHERE $mysql_filtro_data AND $mysql_fornecedor AND $mysql_cod_produto AND $mysql_filial AND $mysql_status ORDER BY codigo");
$linha_contrato = mysqli_num_rows ($busca_contrato);

$busca_produto_distinct = mysqli_query ($conexao, "SELECT DISTINCT cod_produto FROM contrato_adiantamento WHERE $mysql_filtro_data AND $mysql_fornecedor AND $mysql_cod_produto AND $mysql_filial AND $mysql_status ORDER BY codigo");
$linha_produto_distinct = mysqli_num_rows ($busca_produto_distinct);

$soma_contrato = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor) FROM contrato_adiantamento WHERE $mysql_filtro_data AND $mysql_fornecedor AND $mysql_cod_produto AND $mysql_filial AND $mysql_status"));
...
<div class="ct_topo_2">
	...
	<div class="link_4">
    <a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_adiantamento/adto_selec_fornecedor.php"><i>Pesquisar por Fornecedor</i></a>
    </div>
    </div>
</div>
<!-- ============================================================================================================= -->
...
<div style="width:150px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
    ...
    <a href="<?php echo "$servidor/$diretorio_servidor"; ?>/compras/contrato_adiantamento/cadastro_1_selec_produto.php">
	<button type="submit" class="botao_1">Novo Contrato</button></a>
	<?php
	/*
	if ($linha_compra >= 1)
	{echo"
...
<!-- ============================================================================================================= -->
<div class="submenu" style="height:3px"></div>
<div class="espacamento_15"></div>
<!-- ============================================================================================================= -->
...
<!-- ============================================================================================================= -->
<div class="ct_topo_1">
	<div class="ct_titulo_1" style="color:#999">
    Novo Contrato
    </div>
...
<?php
$modulo = "compras";
$menu = "contrato_adiantamento";

$mostra_preco = "NAO";

include ("../../includes/seleciona_produto_2.php");
?>
