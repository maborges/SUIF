...
<body onload="javascript:foco('ok');">
	...
	<div id="centro_geral">
		<div id="centro" style="height:440px; width:950px; border:0px solid #000; margin:auto">
				...
				<div id="titulo_form_3" style="width:700px; height:20px; float:left; border:0px solid #000; margin-left:140px">
					...
					if ($erro == 3) {
						...
						echo "
							...
							<input type='image' src='$servidor/$diretorio_servidor/imagens/icones/doc_3.png' border='0' title='Ficha do Produtor' style='width:70%;height:70%' />
							</form></div>";
					}
					?>
				</div>
			...
			<div style="width:1080px; height:30px; float:left; border:0px solid #000"></div>
			<!-- ============================================================================================================= -->
			...
			<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>N&uacute;mero do Romaneio:
			</div>
			...
			<div id="tabela_2" style="width:350px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:345px; height:5px; border:0px solid #000"></div>Fornecedor:
			</div>
			...
			<!-- ====================================================================================== -->
			<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>Peso L&iacute;quido (Kg):
			</div>

			<div id="tabela_1" style="width:30px; height:19px; border:0px solid #000"></div>
			<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>Tipo Sacaria:
			</div>
			...
			<div id="tabela_2" style="width:240px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:235px; height:5px; border:0px solid #000"></div>Motorista:
			</div>

			<!-- =========================================  PESO LIQUIDO ====================================== -->
			<div id="tabela_2" style="width:150px; border:0px solid #000">
				<input type="text" name="peso_liquido" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" value="<?php echo "$quantidade_print"; ?>" disabled="disabled" />
			</div>
			...
			<div id="tabela_1" style="width:30px; height:19px; border:0px solid #000"></div>
			<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
				<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>Tipo
			</div>
			...
			<!-- =========================================  QUANTIDADE  ====================================== -->
			<div id="tabela_2" style="width:150px; border:0px solid #000">
				<input type="text" name="quantidade" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" value="<?php echo "$quantidade_real_print"; ?>" disabled="disabled" />
			</div>
			...
			<div id="tabela_2" style="width:730px; height:19px; border:0px solid #000; color:#228B22">
				<div id="espaco_1" style="width:725px; height:5px; border:0px solid #000"></div>Desconto previsto a ser aplicado (Qualidade): <?php echo "<b>$desconto_previsto_print Kg</b>"; ?>
			</div>
