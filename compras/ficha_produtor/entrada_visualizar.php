...
for ($e=1 ; $e<=$linha_entrada ; $e++)
{
$aux_entrada = mysqli_fetch_row($busca_entrada);
}

$quantidade_entrada = $aux_entrada[5];
$quantidade_entrada_print = number_format($quantidade_entrada,2,",",".");
$desconto_quantidade = $aux_entrada[29];
$desconto_quantidade_print = number_format($desconto_quantidade,2,",",".");
$unidade_entrada = $aux_entrada[8];
$observacao_entrada = $aux_entrada[13];
...
<div id="centro" style="height:480px; width:1080px; border:0px solid #0000FF; margin:auto">
...
<div id="centro" style="width:1050px; border:0px solid #000; color:#003466; margin-left:25px; font-size:17px; float:left" align="center">
    <div id="centro" style="width:345px; height:20px; border:0px solid #000; color:#003466; font-size:12px; float:left" align="left">N&ordm; <?php echo"$numero_compra"; ?></div>
    <div id="centro" style="width:345px; height:20px; border:0px solid #000; font-size:14px; float:left" align="center">
	<?php
	echo "<b style='color:#003466'>Entrada de Mercadoria</b>";
	?>
	</div>
    <div id="centro" style="width:345px; height:20px; border:0px solid #000; color:003466; font-size:12px; float:left" align="right">N&ordm; Romaneio: <?php echo"$numero_romaneio"; ?></div>
</div>
...
<!-- ========================================================== DADOS DO PRODUTO ============================================================================= -->
	...
	<div style="margin-top:3px; margin-left:55px"><!-- Dados do Produto:--></div></div>
		<div id="centro" style="width:1030px; height:270px; border:0px solid #999; color:#003466; border-radius:5px; overflow:hidden; margin-left:25px">
			...
			<div style="width:500px; height:20px; border:0px solid #000; float:left; font-size:11px; margin-left:25px; color:#FF0000">
			<div style="margin-top:3px; margin-left:5px; float:left">Quantidade de entrada:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<b>$quantidade_entrada_print $unidade_entrada</b>" ?></div></div>

			<div style="width:500px; height:20px; border:0px solid #000; float:left; font-size:11px; color:#FF0000">
			<div style="margin-top:3px; margin-left:5px; float:left">Desconto:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$desconto_quantidade_print $unidade_entrada" ?></div></div>


			<div style="width:1025px; height:5px; border:0px solid #000; float:left; font-size:11px"></div>
			
			<div style="width:500px; height:20px; border:0px solid #000; float:left; font-size:11px; margin-left:25px">
			<div style="margin-top:3px; margin-left:5px; float:left">Quantidade real em sacas:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$quantidade_real_print Sacas" ?></div></div>

			<div style="width:500px; height:20px; border:0px solid #000; float:left; font-size:11px; color:#FF0000">
			<div style="margin-top:3px; margin-left:5px; float:left"><!-- Quantidade de entrada: --></div><div style="margin-top:3px; margin-left:5px; float:left"><?php // echo"$quantidade_entrada_print $unidade_entrada" ?></div></div>
			...
			<div style="width:1000px; height:20px; border:0px solid #000; float:left; font-size:11px; margin-left:25px">
			<div style="margin-top:3px; margin-left:5px; float:left">Observa&ccedil;&atilde;o do romaneio:</div>
			<div style="margin-top:3px; margin-left:5px; width:800px; height:14px; float:left; border:0px solid #000; overflow:hidden"><?php echo"$observacao" ?></div></div>

			<div style="width:1025px; height:5px; border:0px solid #000; float:left; font-size:11px"></div>

			<div style="width:1000px; height:20px; border:0px solid #000; float:left; font-size:11px; margin-left:25px; color:#FF0000">
			<div style="margin-top:3px; margin-left:5px; float:left">Observa&ccedil;&atilde;o da entrada:</div>
			<div style="margin-top:3px; margin-left:5px; width:800px; height:14px; float:left; border:0px solid #000; overflow:hidden"><?php echo"$observacao_entrada" ?></div></div>
...
<div id="centro" style="width:1030px; height:20px; border:0px solid #000; font-size:9px; margin-top:0px; color:#666666">
...
// DADOS DO FAVORECIDO =========================
	...
	$busca_p2_aux = mysqli_fetch_row($busca_pessoa_2);
	
	$nome_favorecido_2 = $busca_p2_aux[1];
	$tipo_pessoa_2 = $busca_p2_aux[2];
		if ($tipo_pessoa_2 == "pf")
		{$cpf_cnpj_2 = $busca_p2_aux[3];}
		else
		{$cpf_cnpj_2 = $busca_p2_aux[4];;}
