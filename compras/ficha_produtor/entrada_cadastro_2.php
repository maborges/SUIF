...
$busca_rme = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND (numero_romaneio='$num_romaneio_manual' OR num_romaneio_manual='$num_romaneio_manual')");
...
<form name="popup" action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/ficha_produtor/entrada_enviar_2.php" method="post">
...
<div style="width:950px; height:30px; float:left; border:0px solid #000">
    ...
    Entrada Direta<?php echo "$produto_print_titulo"; ?>
    </div>
</div>
...
<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/ficha_produtor/entrada_seleciona_2.php">
