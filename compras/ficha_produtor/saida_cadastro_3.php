...
elseif ($linhas_rmc >= 1)
{$erro = 3;
$msg_erro = "* J&aacute; existe um cadastro de sa&iacute;da com este n&uacute;mero de romaneio manual. (N&ordm; Registro: $numero_rmc)";}

elseif ($linhas_rme >= 1)
{$erro = 4;
$msg_erro = "* J&aacute; existe um romaneio da balan&ccedil;a para esta sa&iacute;da. (N&ordm; Romaneio: $numero_rme)";}
...
<form name="popup" action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/ficha_produtor/saida_enviar_3.php" method="post">
...
<div style="width:950px; height:30px; float:left; border:0px solid #000">
    ...
    Sa&iacute;da<?php echo "$produto_print_titulo"; ?>
    </div>
</div>
...
<div id="espaco_1" style="width:595px; height:5px; border:0px solid #000"></div>Fornecedor (F2):</div>
...
<input type='checkbox' name='movimenta_estoque' value='SIM' >Movimenta&ccedil;&atilde;o - Sa&iacute;da no estoque.
</div>
...
{echo "<button type='submit' class='botao_2' style='margin-left:480px; width:120px'>Confirmar</button>";}
?>

<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/ficha_produtor/saida_seleciona_3.php">
<button type='submit' class='botao_2' style='margin-left:480px; width:120px'>Voltar</button></a>
</div>
