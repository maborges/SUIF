...
<div id="centro" style="height:35px; width:1080px; border:0px solid #000; margin:auto">
	...
	<div id="centro" style="height:30px; width:320px; border:1px solid #999; color:#666; font-size:11px; border-radius:5px; float:left">
		...
		<input type="image" src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/buscar.png" height="20" title="Buscar por n&ordm; tal&atilde;o" style="float:left" />
		</form>
		</div>
	</div>
	...
	<div id="centro" style="height:30px; width:350px; border:1px solid #999; color:#666; font-size:11px; border-radius:5px; float:left">
		...
		<input type="image" src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/buscar.png" height="20" style="float:left" />
		</form>
		</div>
	</div>
...
if ($botao == "taloes_divergentes" and $taloes_divergentes == "sim")
{
	...
	echo "
		...
		<input type='image' src='$servidor/$diretorio_servidor/imagens/botoes/buscar.png' height='18px' /></form>	
		</td>
