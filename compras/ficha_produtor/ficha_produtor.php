...
if ($linha_fornecedor == 1) {
	...
	include("../../includes/conecta_bd.php");
	$soma_quant_entrada = mysqli_fetch_row(mysqli_query(
		$conexao,
		"SELECT
	SUM(quantidade)
FROM
...
WHERE
	...
	$soma_quant_saida = mysqli_fetch_row(mysqli_query(
		$conexao,
		"SELECT
	SUM(quantidade)
FROM
...
if ($linha_fornecedor == 1) {
	...
	include("../../includes/conecta_bd.php");
	$soma_ant_entrada = mysqli_fetch_row(mysqli_query(
		$conexao,
		"SELECT
	SUM(quantidade)
FROM
...
WHERE
	...
	$soma_ant_saida = mysqli_fetch_row(mysqli_query(
		$conexao,
		"SELECT
	SUM(quantidade)
FROM
