...
$data_hoje = date('d/m/Y', time());
	// 2 mêses atras
$mes_atras = date ('d/m/Y', strtotime('-60 days'));
	// 1 mês atras
//$mes_atras = date ('d/m/Y', strtotime('-30 days'));


$filial = $filial_usuario;
$produtor_ficha = $_POST["representante"];
$botao = $_POST["botao"];
...
// PRODUTO PRINT  ==========================================================================================
	...
	{$produto_list_print = "Caf&eacute; Conilon";
	$link_compra = "cafe";
	$un_print = "Sc";}
	elseif ($produto_list == "PIMENTA")
	{$produto_list_print = "Pimenta do Reino";
	$link_compra = "pimenta";
	$un_print = "Kg";}
	elseif ($produto_list == "CACAU")
	{$produto_list_print = "Cacau";
	$link_compra = "cacau";
	$un_print = "Kg";}
	elseif ($produto_list == "CRAVO")
	{$produto_list_print = "Cravo da &Iacute;ndia";
	$link_compra = "cravo";
	$un_print = "Kg";}
	elseif ($produto_list == "RESIDUO_CACAU")
	{$produto_list_print = "Res&iacute;duo de Cacau";
	$link_compra = "residuo_cacau";
	$un_print = "Kg";}
	else
	{$produto_list_print = "-";
	$un_print = "";}
...
{$monstra_situacao = $_POST["monstra_situacao"];}
	...
	$busca_compra = mysqli_query ($conexao, "SELECT * FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' ORDER BY data_compra");
	$linha_compra = mysqli_num_rows ($busca_compra);
	

// SOMA COMPRAS  ==========================================================================================
	$soma_compras = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' "));
	$soma_compras_print = number_format($soma_compras[0],2,",",".");

// SOMA SALDO ANTERIOR  ==========================================================================================
	$soma_ant_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra<='$dia_atras' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial'"));
	$soma_ant_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra<='$dia_atras' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial'"));
...
// SOMA CAFE  ==========================================================================================
	$soma_compra_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CAFE' "));
	$soma_cafe_print = number_format($soma_compra_cafe[0],2,",",".");

	$soma_quant_cafe_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CAFE' "));
	$quant_cafe_e_print = number_format($soma_quant_cafe_e[0],2,",",".");
	$soma_quant_cafe_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CAFE' "));
	$quant_cafe_s_print = number_format($soma_quant_cafe_s[0],2,",",".");

	$soma_quant_total_cafe_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CAFE' "));
	$quant_cafe_total_e_print = number_format($soma_quant_total_cafe_e[0],2,",",".");
	$soma_quant_total_cafe_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CAFE' "));
...
// SOMAS PIMENTA  ==========================================================================================
	$soma_compra_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='PIMENTA' "));
	$soma_pimenta_print = number_format($soma_compra_pimenta[0],2,",",".");

	$soma_quant_pimenta_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='PIMENTA' "));
	$quant_pimenta_e_print = number_format($soma_quant_pimenta_e[0],2,",",".");
	$soma_quant_pimenta_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='PIMENTA' "));
	$quant_pimenta_s_print = number_format($soma_quant_pimenta_s[0],2,",",".");

	$soma_quant_total_pimenta_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='PIMENTA' "));
	$quant_pimenta_total_e_print = number_format($soma_quant_total_pimenta_e[0],2,",",".");
	$soma_quant_total_pimenta_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='PIMENTA' "));
...
// SOMAS CACAU  ==========================================================================================
	$soma_compra_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CACAU' "));
	$soma_cacau_print = number_format($soma_compra_cacau[0],2,",",".");

	$soma_quant_cacau_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CACAU' "));
	$quant_cacau_e_print = number_format($soma_quant_cacau_e[0],2,",",".");
	$soma_quant_cacau_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CACAU' "));
	$quant_cacau_s_print = number_format($soma_quant_cacau_s[0],2,",",".");

	$soma_quant_total_cacau_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CACAU' "));
	$quant_cacau_total_e_print = number_format($soma_quant_total_cacau_e[0],2,",",".");
	$soma_quant_total_cacau_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CACAU' "));
...
// SOMAS CRAVO  ==========================================================================================
	$soma_compra_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CRAVO' "));
	$soma_cravo_print = number_format($soma_compra_cravo[0],2,",",".");

	$soma_quant_cravo_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CRAVO' "));
	$quant_cravo_e_print = number_format($soma_quant_cravo_e[0],2,",",".");
	$soma_quant_cravo_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CRAVO' "));
	$quant_cravo_s_print = number_format($soma_quant_cravo_s[0],2,",",".");

	$soma_quant_total_cravo_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CRAVO' "));
	$quant_cravo_total_e_print = number_format($soma_quant_total_cravo_e[0],2,",",".");
	$soma_quant_total_cravo_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='CRAVO' "));
...
// SOMAS RESIDUO_CACAU  ==========================================================================================
	$soma_compra_residuo_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM compras WHERE estado_registro!='EXCLUIDO' AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='RESIDUO_CACAU' "));
	$soma_residuo_cacau_print = number_format($soma_compra_residuo_cacau[0],2,",",".");

	$soma_quant_residuo_cacau_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='RESIDUO_CACAU' "));
	$quant_residuo_cacau_e_print = number_format($soma_quant_residuo_cacau_e[0],2,",",".");
	$soma_quant_residuo_cacau_s = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='COMPRA' OR movimentacao='TRANSFERENCIA_SAIDA' OR movimentacao='SAIDA' OR movimentacao='SAIDA_FUTURO') AND data_compra>='$data_inicial' AND data_compra<='$data_final' AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='RESIDUO_CACAU' "));
	$quant_residuo_cacau_s_print = number_format($soma_quant_residuo_cacau_s[0],2,",",".");

	$soma_quant_total_residuo_cacau_e = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM compras WHERE estado_registro!='EXCLUIDO' AND (movimentacao='ENTRADA' OR movimentacao='TRANSFERENCIA_ENTRADA' OR movimentacao='ENTRADA_FUTURO') AND produto='$produto_list' AND fornecedor='$produtor_ficha' AND filial='$filial' AND produto='RESIDUO_CACAU' "));
...
// BUSCA PESSOA  ==========================================================================================
$busca_pessoa_e = mysqli_query ($conexao, "SELECT * FROM cadastro_pessoa WHERE estado_registro!='EXCLUIDO' AND codigo='$produtor_ficha' ORDER BY nome");
...
$busca_talao = mysqli_query ($conexao, "SELECT * FROM talao_controle WHERE estado_registro!='EXCLUIDO' AND codigo_pessoa='$produtor_ficha' AND devolvido='N' AND filial='$filial' ORDER BY codigo");
$linha_talao = mysqli_num_rows ($busca_talao);

// BUSCA CONTRATO FUTURO  ==========================================================================================
$busca_futuro = mysqli_query ($conexao, "SELECT * FROM contrato_futuro WHERE estado_registro!='EXCLUIDO' AND produtor='$produtor_ficha' AND situacao_contrato='EM_ABERTO' AND filial='$filial' ORDER BY codigo");
$linha_futuro = mysqli_num_rows ($busca_futuro);

// BUSCA CONTRATO TRATADO  ==========================================================================================
$busca_tratado = mysqli_query ($conexao, "SELECT * FROM contrato_tratado WHERE estado_registro!='EXCLUIDO' AND produtor='$produtor_ficha' AND situacao_contrato='EM_ABERTO' AND filial='$filial' ORDER BY codigo");
...
<div id='centro' style='width:720px; height:62px; border:0px solid #D85; float:left; margin-top:25px; margin-left:10px; font-size:17px' align='center'>
	...
	echo "
	<div id='centro' style='width:430px; height:18px; border:0px solid #000; font-size:12px; float:left' align='center'><b>$produto_list_print</b></div>
