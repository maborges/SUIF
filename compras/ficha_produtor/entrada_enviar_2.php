...
$observacao = "(ENTRADA DIRETA - ROMANEIO MANUAL N&ordm; ". $num_romaneio_manual . ") " . $obs;
...
<div id='centro' style='float:left; height:90px; width:925px; color:#F00; text-align:center; border:0px solid #000'>
		<form action='$servidor/$diretorio_servidor/compras/ficha_produtor/entrada_cadastro_2.php' method='post'>
		...
		<button type='submit' class='botao_2' style='margin-left:480px; width:120px'>Voltar</button>
		</form>
</div>";
}
...
-->
		...
		<div id='centro' style='float:left; height:90px; width:185px; color:#00F; text-align:center; border:0px solid #000'>
		<form action='$servidor/$diretorio_servidor/compras/ficha_produtor/entrada_seleciona_2.php' method='post'>
