...
$valor_pagamento_print = number_format($_POST["valor_pagamento"] ?? "0", 2, ",", ".");
...
if ($forma_pagamento == "PREVISAO") {
	...
	if ($forma_pagamento == "") {
		...
		// Calcula quantidade referente ao valor a pagar
		// Faz o arredondamento do valor com 4 decimais para chegar ao mais próximo possível do valor exato
		// e depois trunca para 3 decimais para trabalhar com somente 3 casas.
		$qtdeFaturar = number_format(round($valor_pagamento / $valor_total,4), 3, '.','');
		...
		$resultCabecalhoNF = Sankhya::alteraCabecalhoNota($pedidoFaturamento, $produtorSankhya, $favorecidoSankya);
	...
	$resultCancela = Sankhya::cancelaPedidoCompra($idPedidoSankhya);
