...
// ===============================================================
	...
	elseif ($tipo_conta == "corrente" and $banco_ted == "104" and $aux_cpf_fav[2] == "pf")
	{
		$codigo_ope = "001";
	}
	elseif ($tipo_conta == "corrente" and $banco_ted == "104" and $aux_cpf_fav[2] == "pj")
	{
		$codigo_ope = "003";
	}
	else
...
elseif ($botao == "incluir")
{
		...
		else
		{
			...
			situacao_pagamento, filial, codigo_pessoa, numero_cheque, banco_ted, codigo_fornecedor, produto, favorecido_print, cod_produto) VALUES 
			(NULL, '$numero_compra', '$codigo_favorecido', '$forma_pagamento', '$data_pagamento', '$valor_pagamento', 
...
<input type="image" src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/botao_confirmar.png" border="0" style="margin-left:0px" />
</form>
</div>
...
<?php
	...
	echo "
		...
		<input type='hidden' name='numero_compra' value='$numero_compra'>
		<input type='image' src='$servidor/$diretorio_servidor/imagens/botoes/imprimir_recibo.jpg' border='0' /></form>
		</div>";}
