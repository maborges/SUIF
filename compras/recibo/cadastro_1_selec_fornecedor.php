...
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/recibo/cadastro_1_selec_fornecedor.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/compras/recibo/cadastro_2_formulario.php' method='post'>
