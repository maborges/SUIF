...
include ("../../helpers.php");
$pagina = "relatorio_transferencia_impressao";
$titulo = "Relat&oacute;rio de Transfer&ecirc;ncias";
$modulo = "compras";
$menu = "relatorios";
// ================================================================================================================
...
// ===============================================================================================================
if ($linha_compra == 1)
{$print_quant_reg = "$linha_compra TRANSFER&Ecirc;NCIA";}
elseif ($linha_compra > 1)
{$print_quant_reg = "$linha_compra TRANSFER&Ecirc;NCIAS";}
else
{$print_quant_reg = "";}
// ===============================================================================================================
...
<div style='width:750px; border:0px solid #000; margin-top:1px; float:left; color:#FFF; font-size:9px; text-align:center'>
	<div style='width:60px; height:20px; border:1px solid #000; float:left; background-color:#666; margin-left:2px'><div style='margin-top:4px'>Data</div></div>
	...
	<div style='width:60px; height:20px; border:1px solid #000; float:left; background-color:#666; margin-left:2px'><div style='margin-top:4px'>N&ordm;</div></div>
	...
	<div style='width:105px; height:20px; border:1px solid #000; float:left; background-color:#666; margin-left:2px'><div style='margin-top:4px'>Movimenta&ccedil;&atilde;o</div></div>
	<div style='width:80px; height:20px; border:1px solid #000; float:left; background-color:#666; margin-left:2px'><div style='margin-top:4px'>Filial</div></div>
</div>";
...
{$movimentacao_print = "TRANSF. ENTRADA";}
elseif ($movimentacao_w == "TRANSFERENCIA_SAIDA")
{$movimentacao_print = "TRANSF. SA&Iacute;DA";}
else
...
// ====== RELATORIO =====================================================================================
	...
	<div style='width:750px; height:17px; border:1px solid #FFF; margin-top:4px; float:left; color:#000; font-size:10px'>
		...
		<div style='height:11px; margin-left:0px; margin-top:2px; overflow:hidden'>$produto_w</div>
		</div>
		...
		<div style='width:105px; height:15px; border:1px solid #FFF; float:left; text-align:left; background-color:#FFF; margin-left:2px'>
		<div style='height:11px; margin-left:0px; overflow:hidden; margin-top:2px'>$movimentacao_print</div>
		</div>

		<div style='width:80px; height:15px; border:1px solid #FFF; float:left; text-align:left; background-color:#FFF; margin-left:2px'>
		<div style='height:11px; margin-left:0px; overflow:hidden; margin-top:2px'>$filial_w</div>
		</div>
