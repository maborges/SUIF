<?php
	...
	$pagina = 'relatorios';
	$titulo = 'Relat&oacute;rios de Contratos Tratados';
	$menu = 'contratos';
	$modulo = 'compras';
...
<div style="width:1080px; height:30px; float:left; border:0px solid #000">
    ...
    Relat&oacute;rios de Contratos Tratados:
    </div>
</div>
...
#atalho_relatorio a:hover {
	...
	<div id="centro" style="height:40px; width:1080px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:380px; height:38px; float:left; border:0px solid #999">
			...
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_tratado/relatorio_periodo.php">&#8226; Contratos por Per&iacute;odo</a>
			</div>
		</div>
		...
		<div id="geral" style="width:380px; height:38px; float:left; border:0px solid #999">
			<div id="atalho_relatorio">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_tratado/relatorio_fornecedor_seleciona.php">&#8226; Contratos por Fornecedor</a>
			</div>
		</div>
	</div>
	...
	<div id="centro" style="height:40px; width:1080px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:380px; height:38px; float:left; border:0px solid #999">
			<div id="atalho_relatorio">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_tratado/relatorio_produto.php">&#8226; Contratos por Produto</a>
			</div>
		</div>
		...
		<div id="geral" style="width:380px; height:38px; float:left; border:0px solid #999">
			<div id="atalho_relatorio">
            <a href="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/contrato_tratado/relatorio_contratos_excluidos.php">&#8226; Contratos Exclu&iacute;dos</a>
			</div>
		</div>
	</div>
