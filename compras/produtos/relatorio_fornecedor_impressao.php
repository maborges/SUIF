...
<div id='centro' style='width:740px; border:0px solid #000; margin-top:1px; margin-left:40px; float:left'>
	...
	<div id='centro' style='width:370px; height:15px; border:0px solid #000; float:left; font-size:10px'>";
	echo "<i>Per&iacute;odo: <b>$data_inicial_aux</b> at&eacute; <b>$data_final_aux</b> | Produto: <b>$produto_print_principal</b></i>";
