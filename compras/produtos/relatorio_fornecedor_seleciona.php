...
<form name="popup" action="<?php echo"$servidor/$diretorio_servidor"; ?>/compras/produtos/relatorio_fornecedor.php" method="post">
...
<div style="width:1080px; height:30px; float:left; border:0px solid #000">
	<div id="titulo_form_1" style="width:700px; height:30px; float:left; border:0px solid #000; margin-left:185px; font-size:22px; color:#090">
...
<div style="width:1080px; height:20px; float:left; border:0px solid #000">
	<div id="titulo_form_2" style="width:700px; height:20px; float:left; border:0px solid #000; margin-left:185px; font-size:11px; color:#003466">
...
<div style="width:1080px; height:35px; float:left; border:0px solid #000">
    ...
    <img src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/icones/icone_visualizar.png" border="0" height="18px" onclick="javascript:abrir('busca_pessoa_popup.php'); javascript:foco('busca');" title="Pesquisar fornecedor" />
    </div>
