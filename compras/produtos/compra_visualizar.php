...
<!-- ========================================================== DADOS DO VENDEDOR ============================================================================= -->
	...
	<div style="margin-top:3px; margin-left:55px">Dados do Produtor:</div></div>
...
<!-- ========================================================== DADOS DA COMPRA ============================================================================= -->
	<div id="tabela_2" style="width:1030px; height:15px; border:0px solid #000; font-size:9px; margin-top:20px">
	<div style="margin-top:3px; margin-left:55px">Dados da Compra:</div></div>
		<div id="centro" style="width:1030px; height:70px; border:1px solid #999; color:#003466; border-radius:5px; overflow:hidden; margin-left:25px">
			...
			<div style="margin-top:3px; margin-left:5px; float:left">Saldo a Pagar:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<font style='color:#FF0000'>R$ $saldo_pagamento_print</font>" ?></div></div>
...
<div id="tabela_2" style="width:1030px; height:15px; border:0px solid #000; font-size:9px; margin-top:20px">
<div style="margin-top:3px; margin-left:55px">Dados do Pagamento:</div></div>
