<?php
	...
	$pagina = 'relatorio_comprador_impressao';
...
<div id='centro' style='width:740px; height:62px; border:0px solid #D85; float:left; margin-top:25px; margin-left:40px; font-size:17px' align='center'>
	...
	echo "
	<div id='centro' style='width:430px; height:18px; border:0px solid #000; font-size:12px; float:left' align='center'>Comprador: <b>$usuario_comprador</b></div>
