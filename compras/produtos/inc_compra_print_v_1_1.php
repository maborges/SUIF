...
<!-- ================== INICIO DO RELATORIO ================= -->
<div id="tabela_2" style="width:730px; height:88px; border:1px solid #999; color:#000; border-radius:5px; overflow:hidden">
...
<!-- ================== INICIO DO RELATORIO ================= -->
<div id="tabela_2" style="width:730px; height:88px; border:0px solid #999; color:#000; border-radius:5px; overflow:hidden">
...
<div id="centro" style="width:720px; height:32px; border:0px solid #000; margin-left:10px; font-size:17px; float:left" align="center">
