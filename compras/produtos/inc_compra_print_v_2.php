...
<div id="centro" style="width:720px; height:50px; border:0px solid #000; margin-left:25px; font-size:17px; float:left" align="center">
    ...
    <?php
	echo"$data_compra_print $hora_cadastro";
	/*
...
<!-- ========================================================== DADOS DO PRODUTOR ============================================================================= -->
	...
	<div style="margin-top:0px; margin-left:5px">Dados do Produtor:</div></div>
...
<!-- ========================================================== DADOS DA COMPRA ============================================================================= -->
	...
	<div style="margin-top:0px; margin-left:5px">Dados da Compra:</div></div>
		<div id="tabela_2" style="width:730px; height:70px; border:1px solid #999; color:#000; border-radius:5px; overflow:hidden">
			...
			<div style="width:90px; height:15px; border:0px solid #000; float:left; font-size:10px">
			<div style="margin-top:3px; margin-left:5px; float:left">Broca:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<b>$broca</b>" ?></div></div>
			<div style="width:90px; height:15px; border:0px solid #000; float:left; font-size:10px">
			<div style="margin-top:3px; margin-left:5px; float:left">Impureza:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<b>$impureza</b>" ?></div></div>

			<div style="width:705px; height:5px; border:0px solid #000; float:left; font-size:11px"></div>
            
			<div style="width:540px; height:15px; border:0px solid #000; float:left; font-size:9px">
			<div style="margin-top:3px; margin-left:5px; float:left"><!--Observa&ccedil;&atilde;o:--></div><div style="margin-top:3px; margin-left:5px; width:400px; height:14px; float:left; border:0px solid #000; overflow:hidden"><?php // echo"$observacao" ?></div></div>
...
<!-- ================== INICIO DO RELATORIO ================= -->
<div id="tabela_2" style="width:730px; height:123px; border:1px solid #999; color:#000; border-radius:5px; overflow:hidden">
...
<div id="centro" style="width:720px; height:3px; border:0px solid #000; margin-left:10px; font-size:10px; float:left" align="left">
</div>

<div id="centro" style="width:720px; height:14px; border:0px solid #000; margin-left:10px; font-size:10px; float:left" align="left">
<?php
...
<div id="centro" style="width:720px; height:48px; border:0px solid #000; margin-left:10px; font-size:17px; float:left" align="center">
...
<div id="centro" style="width:710px; height:8px; border:0px solid #000; font-size:17px; float:left" align="center"></div>
...
<div id="centro" style="width:735px; border:0px solid #000; margin-top:2px; margin-left:0px; float:left">
...
<div id="centro" style="width:720px; height:65px; border:0px solid #000; margin-left:10px; font-size:17px; float:left" align="center">

<div id="centro" style="width:710px; height:33px; border:0px solid #000; font-size:17px; float:left" align="center"></div>
