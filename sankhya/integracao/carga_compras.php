...
<body onload="loading();">
    ...
    <div class="container pt-3">
        ...
        <form action="#" method="post" id="frmAtualiza" onsubmit="showLoading()">
            ...
            <!--  Verificar se ainda é necessário apresentar os erros na tela
            ...
            <div class="form-row mt-3 d-flex bd-highligh">
                <button type="submit" form="frmAtualiza" value="submit" name="btnBuscar" class="btn btn-outline-secondary btn-sm mr-3 bd-highlight">Buscar</button>
                <button type="submit" form="frmAtualiza" value="submit" name="btnContrato" class="btn btn-outline-secondary btn-sm mr-3 bd-highlight" <?= $hiddenContrato ?>>Gera Contratos</button>
                <button type="submit" form="frmAtualiza" value="submit" name="btnPedido" class="btn btn-outline-secondary btn-sm mr-3 bd-highlight" <?= $hiddenFatura ?>>Gera Pedidos</button>
                <button type="submit" form="frmAtualiza" value="submit" name="btnExcluir" class="btn btn-outline-danger btn-sm ml-3 ml-auto bd-highlight">Efetiva Exclusões Pendentes</button>
            </div>
            <br>
...
function GeraPedidos()
{
    ...
    foreach ($faturas['rows'] as $fatura) {
        ...
        $resultSet = Sankhya::alteraCabecalhoNota(
            $idFaturaSankhya,
            $idProdutorSankhya,
            $idFavorecidoSankya,
            $dataFaturamento,
