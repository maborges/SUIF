...
$pagina = "contas_pagar_selec_fornecedor";
...
<!-- ============================================================================================================= -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/financeiro/contas_pagar/contas_pagar_selec_fornecedor.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/financeiro/contas_pagar/contas_pagar_periodo.php' method='post'>
