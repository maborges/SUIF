...
$pagina = "pagamentos_selec_fornecedor";
$titulo = "Pagamentos";
$modulo = "financeiro";
$menu = "contas_pagar";
// ================================================================================================================
...
<!-- ============================================================================================================= -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/financeiro/contas_pagar/pagamentos_selec_fornecedor.php" method="post" />
...
<input type="hidden" name="forma_pgto_busca" value="<?php echo"$forma_pgto_busca"; ?>" />
