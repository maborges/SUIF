...
<!-- ================== INICIO DO RELATORIO ================= -->
<?php
if ($linha_favorecidos_pgto <= 16)
{echo "
<div id='tabela_2' style='width:730px; height:410px; border:0px solid #FF0000; color:#000; border-radius:5px; overflow:hidden'>
...
<div id="centro" style="width:720px; height:15px; border:0px solid #CC3333; margin-left:10px; font-size:11px; float:left" align="center">
...
<div id="centro" style="width:720px; height:24px; border:0px solid #FF0000; margin-left:10px; font-size:11px; float:left" align="left">
<?php
