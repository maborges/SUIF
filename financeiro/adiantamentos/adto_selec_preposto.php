...
<!-- ============================================================================================================= -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/financeiro/adiantamentos/adto_selec_preposto.php" method="post" />
...
<input type="hidden" name="status_pgto_busca" value="<?php echo"$status_pgto_busca"; ?>" />
<input type="hidden" name="ordenar_busca" value="<?php echo"$ordenar_busca"; ?>" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<input type='hidden' name='preposto_pesquisa' value='$codigo_w' />
		<input type='hidden' name='nome_preposto' value='$nome_pessoa_w' />
