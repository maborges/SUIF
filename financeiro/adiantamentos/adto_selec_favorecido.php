...
<!-- ============================================================================================================= -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/financeiro/adiantamentos/adto_selec_favorecido.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<input type='hidden' name='favorecido_pesquisa' value='$codigo_pessoa_w' />
		<input type='hidden' name='nome_favorecido' value='$nome_pessoa_w' />
