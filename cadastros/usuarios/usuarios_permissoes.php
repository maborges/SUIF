...
if ($botao == "ATUALIZA" and $permissao[56] == "S") {
	...
	veiculo_filial='$aux_148', vigencia_averbacao='$aux_149', relatorio_averbacao='$aux_150', integracao_sankhya='$aux_151', cadastro_sankhya = '$aux_152' WHERE username='$cod_usuario'");
