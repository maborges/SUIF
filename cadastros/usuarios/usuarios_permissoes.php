...
if ($botao == "ATUALIZA" and $permissao[56] == "S") {
	...
	if ($_POST["aux_5"] == "S") {
		...
		$aux_5 = "N";
	} // [5] cadastro_pessoa_fisica
	if ($_POST["aux_6"] == "S") {
		$aux_6 = "S";
	} else {
		$aux_6 = "N";
	} // [6] cadastro_favorecidos
	if ($_POST["aux_7"] == "S") {
		$aux_7 = "S";
	} else {
		$aux_7 = "N";
	...
	if ($_POST["aux_11"] == "S") {
		...
		$aux_11 = "N";
	} // [11] menu_contrato_futuro
	if ($_POST["aux_12"] == "S") {
		$aux_12 = "S";
	} else {
		$aux_12 = "N";
	} // [12] estoque_movimentacao
	if ($_POST["aux_13"] == "S") {
		$aux_13 = "S";
	} else {
		$aux_13 = "N";
	...
	if ($_POST["aux_18"] == "S") {
		...
		$aux_18 = "N";
	} // [18] estoque_mov_entrada
	if ($_POST["aux_19"] == "S") {
		$aux_19 = "S";
	} else {
		$aux_19 = "N";
	} // [19] estoque_mov_entrada_r
	if ($_POST["aux_20"] == "S") {
		$aux_20 = "S";
	} else {
		$aux_20 = "N";
	} // [20] estoque_mov_saida
	if ($_POST["aux_21"] == "S") {
		$aux_21 = "S";
	} else {
		$aux_21 = "N";
	} // [21] estoque_mov_saida_r
	if ($_POST["aux_22"] == "S") {
		$aux_22 = "S";
	} else {
		$aux_22 = "N";
	} // [22] modulo_financeiro
	if ($_POST["aux_23"] == "S") {
		$aux_23 = "S";
	} else {
		$aux_23 = "N";
	} // [23] financeiro_contas_pagar
	if ($_POST["aux_24"] == "S") {
		$aux_24 = "S";
	} else {
		$aux_24 = "N";
	} // [24] financeiro_contas_receber
	if ($_POST["aux_25"] == "S") {
		$aux_25 = "S";
	} else {
		$aux_25 = "N";
	...
	if ($_POST["aux_27"] == "S") {
		...
		$aux_27 = "N";
	} // [27] financeiro_gerencial
	if ($_POST["aux_28"] == "S") {
		$aux_28 = "S";
	} else {
		$aux_28 = "N";
	} // [28] financeiro_pgtos_relatorios
	if ($_POST["aux_29"] == "S") {
		$aux_29 = "S";
	} else {
		$aux_29 = "N";
	...
	if ($_POST["aux_31"] == "S") {
		...
		$aux_31 = "N";
	} // [31] ficha_produtor_entrada
	if ($_POST["aux_32"] == "S") {
		$aux_32 = "S";
	} else {
		$aux_32 = "N";
	} // [32] ficha_produtor_entrada_2
	if ($_POST["aux_33"] == "S") {
		$aux_33 = "S";
	} else {
		$aux_33 = "N";
	} // [33] ficha_produtor_transferencia
	if ($_POST["aux_34"] == "S") {
		$aux_34 = "S";
	} else {
		$aux_34 = "N";
	} // [34] ficha_produtor_movimentacao
	if ($_POST["aux_35"] == "S") {
		$aux_35 = "S";
	} else {
		$aux_35 = "N";
	} // [35] favorecido_editar
	if ($_POST["aux_36"] == "S") {
		$aux_36 = "S";
	} else {
		$aux_36 = "N";
	} // [36]	favorecido_excluir
	if ($_POST["aux_37"] == "S") {
		$aux_37 = "S";
	} else {
		$aux_37 = "N";
	...
	if ($_POST["aux_40"] == "S") {
		...
		$aux_40 = "N";
	} // [40] preco_compra_maximo
	if ($_POST["aux_41"] == "S") {
		$aux_41 = "S";
	} else {
		$aux_41 = "N";
	} // [41] permite_compra_maximo
	if ($_POST["aux_42"] == "S") {
		$aux_42 = "S";
	} else {
		$aux_42 = "N";
	...
	if ($_POST["aux_46"] == "S") {
		...
		$aux_46 = "N";
	} // [46] contrato_futuro_relatorio
	if ($_POST["aux_47"] == "S") {
		$aux_47 = "S";
	} else {
		$aux_47 = "N";
	} // [47] contrato_futuro_emitir
	if ($_POST["aux_48"] == "S") {
		$aux_48 = "S";
	} else {
		$aux_48 = "N";
	} // [48] contrato_futuro_baixar
	if ($_POST["aux_49"] == "S") {
		$aux_49 = "S";
	} else {
		$aux_49 = "N";
	} // [49] contrato_futuro_estornar
	if ($_POST["aux_50"] == "S") {
		$aux_50 = "S";
	} else {
		$aux_50 = "N";
	} // [50] contrato_futuro_excluir
	if ($_POST["aux_51"] == "S") {
		$aux_51 = "S";
	} else {
		$aux_51 = "N";
	} // [51] acerto_quantidade_compra
	if ($_POST["aux_52"] == "S") {
		$aux_52 = "S";
	} else {
		$aux_52 = "N";
	...
	if ($_POST["aux_53"] == "S") {
		...
		$aux_53 = "N";
	} // [53] registro_excluir_trans
	if ($_POST["aux_54"] == "S") {
		$aux_54 = "S";
	} else {
		$aux_54 = "N";
	} // [54] romaneio_pendente
	if ($_POST["aux_55"] == "S") {
		$aux_55 = "S";
	} else {
		$aux_55 = "N";
	} // [55] usuarios_novo_cadastro
	if ($_POST["aux_56"] == "S") {
		$aux_56 = "S";
	} else {
		$aux_56 = "N";
	} // [56] usuarios_permissoes
	if ($_POST["aux_57"] == "S") {
		$aux_57 = "S";
	} else {
		$aux_57 = "N";
	} // [57] usuarios_desbloqueio
	if ($_POST["aux_58"] == "S") {
		$aux_58 = "S";
	} else {
		$aux_58 = "N";
	...
	if ($_POST["aux_59"] == "S") {
		...
		$aux_59 = "N";
	} // [59] usuarios_relatorio
	if ($_POST["aux_60"] == "S") {
		$aux_60 = "S";
	} else {
		$aux_60 = "N";
	} // [60] classificacao_qualidade
	if ($_POST["aux_61"] == "S") {
		$aux_61 = "S";
	} else {
		$aux_61 = "N";
	} // [61] atualiza_saldo_relatorio
	if ($_POST["aux_62"] == "S") {
		$aux_62 = "S";
	} else {
		$aux_62 = "N";
	} // [62] ficha_produtor_entrada_3
	if ($_POST["aux_63"] == "S") {
		$aux_63 = "S";
	} else {
		$aux_63 = "N";
	} // [63] ficha_produtor_saida_3
	if ($_POST["aux_64"] == "S") {
		$aux_64 = "S";
	} else {
		$aux_64 = "N";
	...
	if ($_POST["aux_70"] == "S") {
		...
		$aux_70 = "N";
	} // [70] editar_pj (pessoas_excluir)
	if ($_POST["aux_71"] == "S") {
		$aux_71 = "S";
	} else {
		$aux_71 = "N";
	} // [71] pessoas_pesquisar
	if ($_POST["aux_72"] == "S") {
		$aux_72 = "S";
	} else {
		$aux_72 = "N";
	} // [72] pessoas_relatorio (impressao)
	if ($_POST["aux_73"] == "S") {
		$aux_73 = "S";
	} else {
		$aux_73 = "N";
	} // [73] pessoas_classificacao
	if ($_POST["aux_74"] == "S") {
		$aux_74 = "S";
	} else {
		$aux_74 = "N";
	} // [74] registro_excluir_antigo
	if ($_POST["aux_75"] == "S") {
		$aux_75 = "S";
	} else {
		$aux_75 = "N";
	} // [75] favorecido_pesquisar
	if ($_POST["aux_76"] == "S") {
		$aux_76 = "S";
	} else {
		$aux_76 = "N";
	...
	if ($_POST["aux_77"] == "S") {
		...
		$aux_77 = "N";
	} // [77] romaneio_finalizar
	if ($_POST["aux_78"] == "S") {
		$aux_78 = "S";
	} else {
		$aux_78 = "N";
	} // [78] romaneio_visualizar
	if ($_POST["aux_79"] == "S") {
		$aux_79 = "S";
	} else {
		$aux_79 = "N";
	} // [79] romaneio_imprimir
	if ($_POST["aux_80"] == "S") {
		$aux_80 = "S";
	} else {
		$aux_80 = "N";
	} // [80] romaneio_excluir_antigo
	if ($_POST["aux_81"] == "S") {
		$aux_81 = "S";
	} else {
		$aux_81 = "N";
	} // [81] romaneio_editar_antigo
	if ($_POST["aux_82"] == "S") {
		$aux_82 = "S";
	} else {
		$aux_82 = "N";
	} // [82] romaneio_nf_entrada
	if ($_POST["aux_83"] == "S") {
		$aux_83 = "S";
	} else {
		$aux_83 = "N";
	} // [83] romaneio_nf_saida
	if ($_POST["aux_84"] == "S") {
		$aux_84 = "S";
	} else {
		$aux_84 = "N";
	...
	if ($_POST["aux_85"] == "S") {
		...
		$aux_85 = "N";
	} // [85] menu_contrato_tratado
	if ($_POST["aux_86"] == "S") {
		$aux_86 = "S";
	} else {
		$aux_86 = "N";
	} // [86] contrato_tratado_relatorio
	if ($_POST["aux_87"] == "S") {
		$aux_87 = "S";
	} else {
		$aux_87 = "N";
	} // [87] contrato_tratado_emitir
	if ($_POST["aux_88"] == "S") {
		$aux_88 = "S";
	} else {
		$aux_88 = "N";
	} // [88] contrato_tratado_baixar
	if ($_POST["aux_89"] == "S") {
		$aux_89 = "S";
	} else {
		$aux_89 = "N";
	} // [89] contrato_tratado_estornar
	if ($_POST["aux_90"] == "S") {
		$aux_90 = "S";
	} else {
		$aux_90 = "N";
	} // [90] contrato_tratado_excluir
	if ($_POST["aux_91"] == "S") {
		$aux_91 = "S";
	} else {
		$aux_91 = "N";
	...
	if ($_POST["aux_100"] == "S") {
		...
		$aux_100 = "N";
	} // [100] servico_producao_cadastro
	if ($_POST["aux_101"] == "S") {
		$aux_101 = "S";
	} else {
		$aux_101 = "N";
	} // [101] servico_producao_editar
	if ($_POST["aux_102"] == "S") {
		$aux_102 = "S";
	} else {
		$aux_102 = "N";
	} // [102] servico_producao_excluir
	if ($_POST["aux_103"] == "S") {
		$aux_103 = "S";
	} else {
		$aux_103 = "N";
	} // [103] tipo_producao_cadastro
	if ($_POST["aux_104"] == "S") {
		$aux_104 = "S";
	} else {
		$aux_104 = "N";
	} // [104] tipo_producao_editar
	if ($_POST["aux_105"] == "S") {
		$aux_105 = "S";
	} else {
		$aux_105 = "N";
	} // [105] tipo_producao_excluir
	if ($_POST["aux_106"] == "S") {
		$aux_106 = "S";
	} else {
		$aux_106 = "N";
	} // [106] ordem_producao_cadastro
	if ($_POST["aux_107"] == "S") {
		$aux_107 = "S";
	} else {
		$aux_107 = "N";
	} // [107] ordem_producao_editar
	if ($_POST["aux_108"] == "S") {
		$aux_108 = "S";
	} else {
		$aux_108 = "N";
	} // [108] ordem_producao_editar_antigo
	if ($_POST["aux_109"] == "S") {
		$aux_109 = "S";
	} else {
		$aux_109 = "N";
	} // [109] ordem_producao_excluir
	if ($_POST["aux_110"] == "S") {
		$aux_110 = "S";
	} else {
		$aux_110 = "N";
	} // [110] ordem_producao_excluir_antigo
	if ($_POST["aux_111"] == "S") {
		$aux_111 = "S";
	} else {
		$aux_111 = "N";
	} // [111] ordem_producao_cadastros
	if ($_POST["aux_112"] == "S") {
		$aux_112 = "S";
	} else {
		$aux_112 = "N";
	} // [112] ordem_producao_mov_int
	if ($_POST["aux_113"] == "S") {
		$aux_113 = "S";
	} else {
		$aux_113 = "N";
	} // [113] romaneio_editar_peso
	if ($_POST["aux_114"] == "S") {
		$aux_114 = "S";
	} else {
		$aux_114 = "N";
	...
	if ($_POST["aux_118"] == "S") {
		...
		$aux_118 = "N";
	} // [118] vendas_editar_tudo
	if ($_POST["aux_119"] == "S") {
		$aux_119 = "S";
	} else {
		$aux_119 = "N";
	} // [119] vendas_editar_antigo
	if ($_POST["aux_120"] == "S") {
		$aux_120 = "S";
	} else {
		$aux_120 = "N";
	...
	if ($_POST["aux_123"] == "S") {
		...
		$aux_123 = "N";
	} // [123] vendas_visualizar
	if ($_POST["aux_124"] == "S") {
		$aux_124 = "S";
	} else {
		$aux_124 = "N";
	} // [124] vendas_nota_fiscal
	if ($_POST["aux_125"] == "S") {
		$aux_125 = "S";
	} else {
		$aux_125 = "N";
	} // [125] vendas_recebimento
	if ($_POST["aux_126"] == "S") {
		$aux_126 = "S";
	} else {
		$aux_126 = "N";
	} // [126] vendas_relatorios
	if ($_POST["aux_127"] == "S") {
		$aux_127 = "S";
	} else {
		$aux_127 = "N";
	...
	if ($_POST["aux_128"] == "S") {
		...
		$aux_128 = "N";
	} // [128] usuarios_excluir
	if ($_POST["aux_129"] == "S") {
		$aux_129 = "S";
	} else {
		$aux_129 = "N";
	} // [129] usuarios_resetar_senha
	if ($_POST["aux_130"] == "S") {
		$aux_130 = "S";
	} else {
		$aux_130 = "N";
	...
	if ($_POST["aux_131"] == "S") {
		...
		$aux_131 = "N";
	} // [131] config_1 (Configurações Gerais)
	if ($_POST["aux_132"] == "S") {
		$aux_132 = "S";
	} else {
		$aux_132 = "N";
	} // [132] config_2 (Cadastro forma de entrega)
	if ($_POST["aux_133"] == "S") {
		$aux_133 = "S";
	} else {
		$aux_133 = "N";
	} // [133] config_3 (Cadastro unidade de medida)
	if ($_POST["aux_134"] == "S") {
		$aux_134 = "S";
	} else {
		$aux_134 = "N";
	...
	if ($_POST["aux_141"] == "S") {
		...
		$aux_141 = "N";
	} // [141] contrato_adto_emitir
	if ($_POST["aux_142"] == "S") {
		$aux_142 = "S";
	} else {
		$aux_142 = "N";
	} // [142] contrato_adto_baixar
	if ($_POST["aux_143"] == "S") {
		$aux_143 = "S";
	} else {
		$aux_143 = "N";
	} // [143] contrato_adto_estornar
	if ($_POST["aux_144"] == "S") {
		$aux_144 = "S";
	} else {
		$aux_144 = "N";
	} // [144] contrato_adto_excluir
	if ($_POST["aux_145"] == "S") {
		$aux_145 = "S";
	} else {
		$aux_145 = "N";
	} // [145] contrato_adto_relatorio
	if ($_POST["aux_147"] == "S") {
		$aux_147 = "S";
	} else {
		$aux_147 = "N";
	} // [147] Situacao Compras

	if ($_POST["aux_148"] == "S") {
		$aux_148 = "S";
	} else {
		$aux_148 = "N";
	} // [148] Veículos da Filial

	if ($_POST["aux_149"] == "S") {
		$aux_149 = "S";
	} else {
		$aux_149 = "N";
	} // [149] Vigência de Averbação

	if ($_POST["aux_150"] == "S") {
		$aux_150 = "S";
	} else {
		$aux_150 = "N";
	} // [150] Relatório de Averbação

	if ($_POST["aux_151"] == "S") {
		$aux_151 = "S";
	} else {
		$aux_151 = "N";
	} // [151] Integração Sankhya

	if ($_POST["aux_152"] == "S") {
		$aux_152 = "S";
	} else {
		$aux_152 = "N";
	} // [152] Cadastros Sankhya

	if ($_POST["aux_153"] == "S") {
		$aux_153 = "S";
	} else {
		$aux_153 = "N";
	} // [153] Cotação Produto Situação
	...
	// MONTA MENSAGEM
	$msg = "<div>Selecione abaixo o usu&aacute;rio e as atribuições/acessos que serão permitidos. Ap&oacute;s alterar clique em salvar.</div>";
}
// ================================================================================================================
			...
			<form name="form1" action="<?php echo "$servidor/$diretorio_servidor"; ?>/cadastros/usuarios/usuarios_permissoes.php" method="post">
				...
				<div style='height:100px; width:1200px; border:1px solid #DCDCDC; color:#003466; font-size:12px; margin:auto; margin-top:20px'>
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[153] == "S") {
							echo "<input type='checkbox' name='aux_153' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_153' value='S'>";
						}
						?>
						Situação da Cotação</div>

					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[154] == "S") {
							echo "<input type='checkbox' name='aux_154' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_154' value='S'>";
						}
						?>
						Cotação de Produtos</div>


				</div>

				<!-- Compras / Ficha Produtor -->
				<div style='height:70px; width:1200px; border:1px solid #DCDCDC; color:#003466; font-size:12px; margin:auto; margin-top:20px'>
					<div style='height:24px; width:1200px; border:0px solid #0099CC; background-color:#DCDCDC; font-size:12px; margin:auto'>
						<div style='height:auto; width:300px; border:0px solid #000; color:#003466; float:left; margin-top:0px; margin-left:23px'>
							<?php
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px' title='Depende de um romaneio criado na balan&ccedil;a'>
						<?php
						if ($x[31] == "S") {
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px' title='Cria romaneio autom&aacute;tico (Movimenta Ficha e Estoque)'>
						<?php
						if ($x[32] == "S") {
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px' title='Cria romaneio de entrada se for selecionado'>
						<?php
						if ($x[62] == "S") {
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px' title='Cria romaneio de sa&iacute;da se for selecionado'>
						<?php
						if ($x[63] == "S") {
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px' title='Transfer&ecirc;ncias entre produtores'>
						<?php
						if ($x[33] == "S") {
				...
				<!-- Estoque / Entrada de Estoque e Saída de Estoque -->
				<div style='height:90px; width:1200px; border:1px solid #DCDCDC; color:#003466; font-size:12px; margin:auto; margin-top:20px'>
					...
					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[148] == "S") {
							echo "<input type='checkbox' name='aux_148' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_148' value='S'>";
						}
						?>
						Veículos da Filial</div>

					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[149] == "S") {
							echo "<input type='checkbox' name='aux_149' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_149' value='S'>";
						}
						?>
						Vigência da Averbação</div>

					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[150] == "S") {
							echo "<input type='checkbox' name='aux_150' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_150' value='S'>";
						}
						?>
						Relatório de Averbação</div>
				...
				<!-- Diversos / Impressão e Gerencial -->
				<div style='height:70px; width:1200px; border:1px solid #DCDCDC; color:#003466; font-size:12px; margin:auto; margin-top:20px'>
					...
					<!-- Sankhya / Cadastro e Integração -->

					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[151] == "S") {
							echo "<input type='checkbox' name='aux_151' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_151' value='S'>";
						}
						?>
						Cadastros Sankhya</div>

					<div style='height:18px; width:215px; border:0px solid #000; float:left; margin-top:2px; margin-left:23px'>
						<?php
						if ($x[152] == "S") {
							echo "<input type='checkbox' name='aux_152' value='S' checked='checked'>";
						} else {
							echo "<input type='checkbox' name='aux_152' value='S'>";
						}
						?>
						Integração Sankhya</div>
