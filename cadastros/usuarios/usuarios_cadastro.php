...
{
// CADASTRO
$inserir = mysqli_query ($conexao, "INSERT INTO usuarios (username, senha, primeiro_nome, nome_completo, email_principal, usuario_interno, celular, contador_bloqueio, estado_registro, filial, usuario_cadastro, data_cadastro, hora_cadastro) VALUES ('$username_form', '$senha_provisoria', '$nome_form', '$nome_form', '$email_form', 'N', '$telefone_form', '0', 'ATIVO', '$filial_form', '$usuario_cadastro_form', '$data_cadastro_form', '$hora_cadastro_form')");
...
{
// EDIÇÃO
$editar = mysqli_query ($conexao, "UPDATE usuarios SET primeiro_nome='$nome_form', nome_completo='$nome_form', email_principal='$email_form', celular='$telefone_form', filial='$filial_form', usuario_alteracao='$usuario_cadastro_form', data_alteracao='$data_cadastro_form', hora_alteracao='$hora_cadastro_form' WHERE username='$username_w'");
...
<div style="width:220px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
    ...
    <div style="width:215px; height:25px; float:left; border:1px solid transparent">
    <input type="text" name="nome_form" class="form_input" maxlength="50"
    onkeydown="if (getKey(event) == 13) return false;" style="width:191px; text-align:left; padding-left:5px" value="<?php echo"$nome_form"; ?>" />
    </div>
</div>
<!-- ================================================================================================================ -->
...
<div style="width:220px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
    ...
    <div style="width:215px; height:25px; float:left; border:1px solid transparent">
    <input type="text" name="email_form" class="form_input" maxlength="50" onBlur="alteraMinusculo(this)"
    onkeydown="if (getKey(event) == 13) return false;" style="width:191px; text-align:left; padding-left:5px" value="<?php echo"$email_form"; ?>" />
    </div>
</div>
<!-- ================================================================================================================ -->
...
<div style="width:154px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
    ...
    <input type="text" name="telefone_form" class="form_input" maxlength="15" id="telddd_1"
    onkeydown="if (getKey(event) == 13) return false;" style="width:125px; text-align:left; padding-left:5px" value="<?php echo"$telefone_form"; ?>" />
    </div>
</div>
<!-- ================================================================================================================ -->
...
<div class="contador">
    ...
    <?php
	if ($permissao[55] == "S")
	{echo "<b>$monta_senha</b> ser&aacute; a senha provis&oacute;ria quando for criado um novo usu&aacute;rio. 
