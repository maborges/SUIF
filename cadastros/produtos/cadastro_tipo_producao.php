...
$pagina = "cadastro_tipo_producao";
$titulo = "Cadastro de Tipo de Produto (Produ&ccedil;&atilde;o)";
$modulo = "cadastros";
...
// CADASTRO
$inserir = mysqli_query ($conexao, "INSERT INTO cad_tipo_producao (id, codigo_tipo, nome_tipo, cod_produto, estado_registro, usuario_cadastro, data_cadastro, hora_cadastro, bloqueio) VALUES (NULL, '$codigo_tipo', '$nome_tipo_form', '$cod_produto_form', 'ATIVO', '$usuario_cadastro_form', '$data_cadastro_form', '$hora_cadastro_form', 'NAO')");
...
// ====== BUSCA CADASTROS ==========================================================================================
$busca_registro = mysqli_query ($conexao, "SELECT * FROM cad_tipo_producao WHERE estado_registro!='EXCLUIDO' ORDER BY cod_produto, id");
...
<div style="width:50px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/cadastros/produtos/cadastro_tipo_producao.php" method="post" />
    <?php
	if ($botao == "EDICAO")
	{echo "
...
<div style="width:100px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
	...
	if ($botao == "EDICAO")
	{echo "
	<form action='$servidor/$diretorio_servidor/cadastros/produtos/cadastro_tipo_producao.php' method='post' />
...
// ====== DADOS DO SERVIÇO =============================================================================
$id_w = $aux_registro[0];
$codigo_tipo_w = $aux_registro[1];
$nome_tipo_w = $aux_registro[2];
$codigo_produto_w = $aux_registro[3];
$estado_registro_w = $aux_registro[6];
$bloqueio_w = $aux_registro[16];
