...
{
// ATIVAR
$ativar_favorecido = mysqli_query ($conexao, "UPDATE cadastro_favorecido SET estado_registro='ATIVO', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao' WHERE codigo='$id_w'");
...
{
// INATIVAR
$inativar_favorecido = mysqli_query ($conexao, "UPDATE cadastro_favorecido SET estado_registro='INATIVO', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao' WHERE codigo='$id_w'");
...
<div style="width:330px; height:50px; border:1px solid transparent; margin-top:6px; float:left">
	...
	style="width:300px; text-align:left; padding-left:5px" value="<?php echo"$nome_busca"; ?>" />
    </div>
</div>
<!-- ================================================================================================================ -->
