...
$idSankhya_pessoa_w =  $aux_favorecido[23];
$idSankhyaCC_pessoa_w =  $aux_favorecido[25];
    ...
    <div class="ct_fixo" style="height:560px">
        ...
        <div style="width:1030px; height:400px; margin:auto; border:1px solid transparent; color:#003466">
                ...
                <div>
                    <div class="pqa_caixa">
                        ...
                        <div class="pqa_campo" style="margin-left:0px;">
                            <input readonly type="number" name="idSankhya_pessoa" class="pqa_input" id="idSankhya_pessoa" maxlength="8" style="width:145px; background-color:#EEE" value="<?php echo $idSankhya_pessoa_w ?>" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="width:100%; height:50px; border:1px solid transparent;  float:left">
                <form>
                    <div class="pqa_caixa">
                        ...
                        <div class="pqa_campo" style="margin-left:0px;">
                            <input readonly type="number" name="idSankhyaCC_form" class="pqa_input" id="idSankhyaCC_form" maxlength="8" onchange="LimpaFormsCC()" style="width:145px; background-color:#EEE;" value="<?php echo $idSankhyaCC_pessoa_w ?>">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div style="width:169px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:167px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:153px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center;         background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:143px; height:16px; color:#003466; text-align:left; overflow:hidden"><?php echo "$agencia_w" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="width:169px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:167px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:153px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:143px; height:16px; color:#003466; text-align:left; overflow:hidden"><?php echo "$conta_w" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="width:169px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:167px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:153px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:143px; height:16px; color:#003466; text-align:left; overflow:hidden"><?php echo "$tipo_conta_print" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="width:169px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:167px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:153px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:143px; height:16px; color:#003466; text-align:left; overflow:hidden"><?php echo "$conta_conjunta_print" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="width:339px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:334px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:324px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:314px; height:16px; text-align:left; overflow:hidden"><?php echo "$chave_pix_w" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="width:680px; height:50px; border:1px solid transparent; margin-top:10px; float:left">
                ...
                <div style="width:668px; height:25px; float:left; border:1px solid transparent">
                    <div style="width:666px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; background-color:#EEE">
                        <div style="margin-top:6px; margin-left:5px; width:654px; height:16px; color:#003466; text-align:left; overflow:hidden"><?php echo "$observacao_w" ?></div>
                    </div>
                </div>
            </div>
            <!-- ================================================================================================================ -->
            ...
            <div style="display: flex; align-items: center; padding: 5px;">
                    <div style="background-color:#EEE; font-size:10px; margin: 5px" >
                        <?= $dados_cadastro_w ?>
                    </div>
                    <div style="background-color:#EEE; font-size:10px; margin: 5px" >
                        <?= $dados_alteracao_w ?>
        ...
        <!-- ============================================================================================================= -->
        <div style="height:60px; width:1270px; border:0px solid #999; margin:auto; display: flex; justify-content: center ">

            <div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
                <form action=<?php echo "$servidor/$diretorio_servidor/cadastros/favorecidos/editar_1_formulario.php"?> method='post'>
                    ...
                    <button type='submit' <?php if ($permite_editar != 'SIM') {
                                                echo 'disabled';
                                            } ?> class='botao_2' style='margin-left:10px; width:180px'>Editar</button>
                </form>
            </div>

            <div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
                <form action=<?php echo "$servidor/$diretorio_servidor/cadastros/favorecidos/$pagina_mae.php"?> method='post'>
                    <input type='hidden' name='pagina_mae' value="<?=$pagina_mae?>">
