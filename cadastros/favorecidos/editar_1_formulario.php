						...
						<div>
							<div class="pqa_caixa">
								...
								<div class="pqa_campo" style="margin-left:0px;">
									<input <?php
											...
											?> type="number" name="idSankhyaCC_form" class="pqa_input" id="idSankhyaCC_form" maxlength="8" value="<?= $idSankhyaCC_form ?>" style="width:145px; <?php
																																																if (!$idSankhya_form) {
							...
							<div class="pqa_caixa">
								...
								<div class="pqa_campo" style="margin-left: 10px;">
									<button <?php if (!$idSankhya_form) {
												echo 'hidden';
											} ?> type='submit' name="btnGetSankhyaCC" style='float:left' value="PESQUISACC" formaction="<?php echo "$servidor/$diretorio_servidor"; ?>/cadastros/favorecidos/editar_1_formulario.php">
										Buscar CC</button>
								</div>
							</div>
						</div>
