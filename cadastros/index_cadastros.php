...
<div style="width:293px; height:250px; border:1px solid #999; margin-left:40px; margin-top:20px; float:left">
    ...
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/pessoas/cadastro_1_formulario.php" >&#8226; Cadastrar Pessoa</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/pessoas/pesquisar_pessoa.php" >&#8226; Pesquisar Cadastro</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/pessoas/relatorio_pessoa.php" >&#8226; Relat&oacute;rio</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/pessoas/classificacao_pessoa.php" >&#8226; Classifica&ccedil;&atilde;o/Fun&ccedil;&atilde;o</a></div>
    </div>
...
<div style="width:293px; height:250px; border:1px solid #999; margin-left:40px; margin-top:20px; float:left">
    ...
    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/favorecidos/cadastro_1_selec_fornecedor.php" >&#8226; Cadastrar Favorecido</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/favorecidos/pesquisar_favorecido.php" >&#8226; Pesquisar Favorecido</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/favorecidos/relatorio_favorecido.php" >&#8226; Relat&oacute;rio</a></div>
    </div>
...
<div style="width:293px; height:250px; border:1px solid #999; margin-left:40px; margin-top:20px; float:left">
    ...
    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/usuarios/usuarios_cadastro.php" >&#8226; Cadastrar Usu&aacute;rio</a></div>
    </div>

    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/usuarios/usuarios_troca_senha.php" >&#8226; Trocar de Senha</a></div>
    </div>
...
<div style="width:293px; height:250px; border:1px solid #999; margin-left:40px; margin-top:20px; float:left">
    ...
    <div style="width:253px; height:20px; margin-left:20px; margin-top:10px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/produtos/preco_compra.php" >&#8226; Alterar Pre&ccedil;o de Compra</a></div>
    </div>
...
<div style="width:293px; height:250px; border:1px solid #999; margin-left:40px; margin-top:20px; float:left">
    ...
    <div style="width:253px; height:20px; margin-left:20px; margin-top:5px; text-align:left; float:left; font-size:13px; color:#003466">
    <div class="link_4" style="float:left; width:auto; height:18px; border:0px solid #000; font-size:13px">
    <a href="<?php echo"$servidor/$diretorio_servidor" ?>/cadastros/configuracoes/config_geral.php" >&#8226; Alterar Configura&ccedil;&otilde;es</a></div>
    </div>
