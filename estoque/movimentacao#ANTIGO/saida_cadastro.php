...
<div id="centro" style="height:30px; width:500px; border:0px solid #000; color:#990000; font-size:14px; margin-left:180px; margin-top:18px"><b>&bull; Sa&iacute;da - Peso Inicial</b></div>
</div>


<form name="compra_cafe" action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/saida_enviar_inicial.php" method="post">
...
<div id="espaco_1" style="width:425px; height:5px; border:0px solid #000"></div>N&ordm; Confirma&ccedil;&atilde;o:</div>
...
<input type="text" name="confirmacao_negocio" maxlength="15" onkeydown="if (getKey(event) == 13) return false;" onBlur="alteraMaiusculo(this)" style="color:#0000FF; width:145px; font-size:12px; text-align:left" />
</div>
...
<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/index_movimentacao.php"><img src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/cancelar.png" border="0" alt="cancelar" /></a>
</div>
