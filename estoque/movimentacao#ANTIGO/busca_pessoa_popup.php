...
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/busca_pessoa_popup.php" method="post" />
...
<input type="image" src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/buscar.png" align="absmiddle" border="0" />
...
<script>
	...
	{
	window.opener.document.compra_cafe.representante.value = retorno;
	window.self.close();
	}
</script>
