...
// PRODUTO PRINT  ==========================================================================================
	...
	desconto_sacaria='$desconto_sacaria', desconto='$desconto', quantidade='$quantidade', tipo_sacaria='$t_sacaria', placa_veiculo='$placa_veiculo', motorista='$motorista', 
	observacao='$observacao', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao', quantidade_sacaria='$quant_sacaria', 
	motorista_cpf='$motorista_cpf', confirmacao_negocio='$confirmacao_negocio' WHERE numero_romaneio='$numero_romaneio'");
