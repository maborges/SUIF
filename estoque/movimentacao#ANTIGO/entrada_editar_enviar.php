...
// =================================================================================================================
	...
	$quant_volume = $_POST["quant_volume"];
...
// PRODUTO PRINT  ==========================================================================================
	...
	$editar = mysqli_query ($conexao, "UPDATE estoque SET fornecedor='$fornecedor', produto='$produto', peso_inicial='$peso_inicial', peso_final='$peso_final', 
	desconto_sacaria='$desconto_sacaria', desconto='$desconto', quantidade='$quantidade', tipo_sacaria='$t_sacaria', placa_veiculo='$placa_veiculo', motorista='$motorista', observacao='$observacao', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao', quantidade_sacaria='$quant_sacaria', filial_origem='$filial_origem', quant_volume_sacas='$quant_volume', num_romaneio_manual='$num_romaneio_manual', cod_produto='$cod_produto', fornecedor_print='$fornecedor_print' WHERE numero_romaneio='$numero_romaneio'");
