...
<div id="centro" style="height:30px; width:500px; border:0px solid #000; color:#990000; font-size:14px; margin-left:180px; margin-top:18px"><b>&bull; Sa&iacute;da - Editar</b></div>
</div>


<form name="compra_cafe" action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/saida_editar_enviar.php" method="post">
...
<img src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/estoque_saida.jpg" border="0" alt="saida" title="Estoque - Sa&iacute;da" style="margin-top:20px" />
</div>
...
<div id="espaco_1" style="width:595px; height:5px; border:0px solid #000"></div>Cliente:</div>
...
<div id="espaco_1" style="width:235px; height:5px; border:0px solid #000"></div>Outros Descontos (Kg):</div>
...
<div id="tabela_1" style="width:30px; border:0px solid #000"></div>
<div id="tabela_2" style="width:150px; border:0px solid #000">
<input type="text" name="peso_final" maxlength="15" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" value="<?php echo "$peso_final"; ?>" /></div>
...
<?php
	...
	$busca_tipo_sacaria = mysqli_query ($conexao, "SELECT * FROM select_tipo_sacaria WHERE movimentacao='SAIDA' ORDER BY codigo");
...
<input type="text" name="desconto" maxlength="15" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" value="<?php echo "$desconto"; ?>" /></div>
...
<div id="tabela_1" style="width:30px; height:19px; border:0px solid #000"></div>
<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>Placa Ve&iacute;culo:</div>
...
<div id="tabela_1" style="width:30px; border:0px solid #000"></div>
<div id="tabela_2" style="width:150px; border:0px solid #000">
<input type="text" name="quant_sacaria" maxlength="15" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" value="<?php echo "$quantidade_sacaria"; ?>" />
</div>
...
<div id="tabela_1" style="width:30px; height:19px; border:0px solid #000"></div>
<div id="tabela_2" style="width:150px; height:19px; border:0px solid #000">
<div id="espaco_1" style="width:145px; height:5px; border:0px solid #000"></div>N&ordm; Confirma&ccedil;&atilde;o:</div>
...
<div id="tabela_1" style="width:30px; border:0px solid #000"></div>
<div id="tabela_2" style="width:150px; border:0px solid #000">
<input type="text" name="confirmacao_negocio" maxlength="15" onkeydown="if (getKey(event) == 13) return false;" onBlur="alteraMaiusculo(this)" style="color:#0000FF; width:145px; font-size:12px; text-align:left" value="<?php echo "$confirmacao_negocio"; ?>" />
</div>
