...
<div id="centro" style="height:510px; width:1080px; border:0px solid #0000FF; margin:auto">
...
<div id="centro" style="width:1050px; border:0px solid #000; color:#003466; margin-left:25px; font-size:17px; float:left" align="center">
	...
	<?php
	if ($situacao_romaneio == "PRE_ROMANEIO")
	{echo "<b style='color:#FF0000'>Pr&eacute;-Romaneio de Sa&iacute;da</b>";}
	else
	{echo "<b style='color:#003466'>Romaneio de Sa&iacute;da</b>";}
	?>
	</div>
...
<!-- ========================================================== DADOS DO FORNECEDOR ============================================================================= -->
	...
	<div style="margin-top:3px; margin-left:55px">Dados do Cliente:</div></div>
...
<!-- ========================================================== DADOS DO PRODUTO ============================================================================= -->
	...
	<div style="margin-top:3px; margin-left:55px"><!-- Dados do Produto:--></div></div>
		<div id="centro" style="width:1030px; height:240px; border:0px solid #999; color:#003466; border-radius:5px; overflow:hidden; margin-left:25px">
...
<div style="margin-top:3px; margin-left:55px">Notas Fiscais de Sa&iacute;da:</div></div>
