...
$pagina = 'entrada_relatorio_periodo';
...
// MOSTRA PESAGEM DE BALANÇA GRANDE E PEQUENA  ==========================================================================================
//=======================================================================================================================================
if ($balanca_peq == "BP")
{
	...
	{	
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
	
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND filial='$filial'"));
	...
	{
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='EM_ABERTO' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
		
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
	}
	...
	{
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='FECHADO' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
		
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
	}
...
// MOSTRA PESAGEM SOMENTE DA BALANÇA GRANDE  ============================================================================================
//=======================================================================================================================================
{
	// TODOS  ==========================================================================================
	if ($monstra_situacao == "TODOS")
	{	
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
	
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND filial='$filial'"));
		$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
	}
	...
	elseif ($monstra_situacao == "EM_ABERTO")
	{
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='EM_ABERTO' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
		
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
		$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
	}
	...
	elseif ($monstra_situacao == "FECHADO")
	{
		$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='FECHADO' AND filial='$filial' ORDER BY codigo");
		$linha_romaneio = mysqli_num_rows ($busca_romaneio);
		
	
		$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
		
		$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CAFE' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
		
		$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='PIMENTA' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
		
		$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CACAU' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
		
		$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND situacao IS NULL AND data>='$data_inicial' AND data<='$data_final' AND produto='CRAVO' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
		$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
	}
...
<div id="centro" style="height:35px; width:1080px; border:0px solid #000; margin:auto">
	...
	&#160;&#160;&#8226; <b>Romaneios de Entrada</b> - Por Per&iacute;odo
	</div>
	
	<div id="centro" style="height:25px; width:22px; border:0px solid #000; float:left"></div>

	<div id="centro" style="height:30px; width:600px; border:1px solid #999; color:#666; font-size:11px; border-radius:5px; float:left">
...
<div id="centro" style="height:35px; width:1080px; border:0px solid #000; margin:auto">
	...
	<div id="centro" style="height:30px; width:922px; border:1px solid #999; color:#666; font-size:11px; border-radius:5px; float:left">
		...
		<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/entrada_relatorio_periodo.php" method="post" />
		<input type='hidden' name='botao' value='1' />
...
// PRODUTO PRINT  ==========================================================================================
$busca_produto_print = mysqli_query ($conexao, "SELECT * FROM cadastro_produto WHERE estado_registro='ATIVO' AND codigo='$cod_produto' ORDER BY codigo");
