...
$pagina = 'entrada_editar_2_enviar';
...
$fornecedor_print = $aux_pessoa[1];
	...
	if ($fornecedor == '' or $p_inicial == '' or $p_inicial <= 0 or $produto == '' )
	{
...
// PRODUTO PRINT  ==========================================================================================
	...
	if ($produto == "CAFE_ARABICA")
	{$produto_print = "Caf&eacute; Ar&aacute;bica";
	$quant_convet = ($quantidade / 60);}
	...
	$editar = mysqli_query ($conexao, "UPDATE estoque SET fornecedor='$fornecedor', produto='$produto', peso_inicial='$peso_inicial', tipo_sacaria='$t_sacaria', desconto_sacaria='$desconto_sacaria', placa_veiculo='$placa_veiculo', motorista='$motorista', motorista_cpf='$motorista_cpf', observacao='$observacao', num_romaneio_manual='$num_romaneio_manual', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao', filial_origem='$filial_origem', cod_produto='$cod_produto', fornecedor_print='$fornecedor_print' WHERE numero_romaneio='$numero_romaneio'");
	
/*	$editar = mysqli_query ($conexao, "UPDATE estoque SET fornecedor='$fornecedor', produto='$produto', peso_inicial='$peso_inicial', 
	desconto_sacaria='$desconto_sacaria', tipo_sacaria='$t_sacaria', placa_veiculo='$placa_veiculo', motorista='$motorista', motorista_cpf='$motorista_cpf',
	observacao='$observacao', usuario_alteracao='$usuario_alteracao', hora_alteracao='$hora_alteracao', data_alteracao='$data_alteracao', 
	quantidade_sacaria='$quant_sacaria', num_romaneio_manual='$num_romaneio_manual',
