...
{	
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	

	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	
	$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CAFE' AND filial='$filial'"));
	$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");

	$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='PIMENTA' AND filial='$filial'"));
	$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
	
	$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CACAU' AND filial='$filial'"));
	$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
	
	$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CRAVO' AND filial='$filial'"));
...
{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);

	
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	
	$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CAFE' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial'"));
	$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
	
	$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='PIMENTA' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial'"));
	$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
	
	$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CACAU' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial'"));
	$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
	
	$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CRAVO' AND situacao_romaneio='PRE_ROMANEIO' AND filial='$filial'"));
	$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
}
...
{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='EM_ABERTO' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	

	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	
	$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CAFE' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
	$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
	
	$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='PIMENTA' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
	$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
	
	$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CACAU' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
	$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
	
	$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CRAVO' AND situacao_romaneio='EM_ABERTO' AND filial='$filial'"));
	$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
}
...
{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='FECHADO' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	

	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	
	$soma_quant_cafe = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CAFE' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
	$quant_cafe_print = number_format($soma_quant_cafe[0],2,",",".");
	
	$soma_quant_pimenta = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='PIMENTA' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
	$quant_pimenta_print = number_format($soma_quant_pimenta[0],2,",",".");
	
	$soma_quant_cacau = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CACAU' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
	$quant_cacau_print = number_format($soma_quant_cacau[0],2,",",".");
	
	$soma_quant_cravo = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND data='$data_hoje' AND produto='CRAVO' AND situacao_romaneio='FECHADO' AND filial='$filial'"));
	$quant_cravo_print = number_format($soma_quant_cravo[0],2,",",".");
}
...
<div id="centro" style="height:40px; width:1080px; border:0px solid #000; margin:auto">
	<div id="centro" style="height:39px; width:70px; border:0px solid #000; float:left"></div>
	<div id="centro" style="height:39px; width:300px; border:0px solid #000; color:#003466; font-size:12px; float:left">
	<div id="geral" style="width:295px; height:8px; float:left; border:0px solid #999"></div>
	&#160;&#160;&#8226; <b>Romaneios de Entrada</b>
	</div>
	
	<form name="compra_cafe" action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/entrada_cadastro_inicial.php" method="post">
	
	<div id="centro" style="height:40px; width:22px; border:0px solid #000; float:left"></div>

	<div id="centro" style="height:40px; width:600px; border:1px solid #999; color:#666; font-size:11px; border-radius:5px; float:left">

		<div id="centro" style="width:595px; float:left; height:20px; border:0px solid #999; text-align:left">
		<div id="geral" style="width:595px; height:10px; float:left; border:0px solid #999"></div>
		<div id="menu_atalho">

			<div id="geral" style="margin-left:20px; margin-top:3px; border:0px solid #999; float:left">
			N&ordm; do Pr&eacute;-Romaneio:</div>
			<div id="geral" style="margin-left:20px; border:0px solid #999; float:left">
			<input type="text" name="numero_romaneio" maxlength="30" onkeydown="if (getKey(event) == 13) return false;" id"ok" style="color:#0000FF; font-size:12px; width:145px"  /></div>			
			<div id="geral" style="margin-left:20px; border:0px solid #999; float:left">
			<input type="image" src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/buscar.png" border="0" title="Buscar Romaneio" /></div>
			<div id="geral" style="margin-left:20px; border:0px solid #999; float:left">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/movimentacao/entrada_cadastro.php"><img src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/botoes/novo.jpg" 
			border="0" alt="novo" title="Novo Romaneio" /></a></div>
	</form>
...
// RELATORIO =========================
	...
	if ($situacao_romaneio == "FECHADO" and $permissao[16] == 'S')
	{	
		echo "
		<td width='54px' align='center'>
