...
// ====== ROMANEIO DE SAIDA AUTOMATICO - SAO MATEUS =======================================================================
	...
	$inserir_saida = mysqli_query ($conexao, "INSERT INTO estoque (codigo, numero_romaneio, fornecedor, data, produto, peso_inicial, peso_final, desconto_sacaria, desconto, quantidade, unidade, tipo_sacaria, movimentacao, situacao_romaneio, placa_veiculo, motorista, observacao, usuario_cadastro, hora_cadastro, data_cadastro, filial, estado_registro, quantidade_sacaria, motorista_cpf, num_romaneio_manual, filial_origem, cod_produto, fornecedor_print) VALUES (NULL, '$n_romaneio', '491', '$data', '$produto', '$peso_final', '$peso_inicial', '$desconto_sacaria', '$desconto', '$quantidade', 'KG', '$t_sacaria', 'SAIDA', '$situacao_romaneio', '$placa_veiculo', '$motorista', '$observacao', '$usuario_cadastro', '$hora_cadastro', '$data_cadastro', 'SAO_MATEUS', 'ATIVO', '$quant_sacaria', '$motorista_cpf', '$numero_romaneio', 'SAO_MATEUS', '$cod_produto', '$fornecedor_print_2')");
	}
...
// ====== ROMANEIO DE SAIDA AUTOMATICO - LINHARES/POLO =======================================================================
	...
	$inserir_saida = mysqli_query ($conexao, "INSERT INTO estoque (codigo, numero_romaneio, fornecedor, data, produto, peso_inicial, peso_final, desconto_sacaria, desconto, quantidade, unidade, tipo_sacaria, movimentacao, situacao_romaneio, placa_veiculo, motorista, observacao, usuario_cadastro, hora_cadastro, data_cadastro, filial, estado_registro, quantidade_sacaria, motorista_cpf, num_romaneio_manual, filial_origem, cod_produto, fornecedor_print) VALUES (NULL, '$n_romaneio', '491', '$data', '$produto', '$peso_final', '$peso_inicial', '$desconto_sacaria', '$desconto', '$quantidade', 'KG', '$t_sacaria', 'SAIDA', '$situacao_romaneio', '$placa_veiculo', '$motorista', '$observacao', '$usuario_cadastro', '$hora_cadastro', '$data_cadastro', 'LINHARES_POLO', 'ATIVO', '$quant_sacaria', '$motorista_cpf', '$numero_romaneio', 'LINHARES_POLO', '$cod_produto', '$fornecedor_print_2')");
	}
