...
// ====== BUSCA ROMANEIO ==========================================================================================
$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND numero_romaneio='$numero_romaneio' AND movimentacao='SAIDA' ORDER BY codigo");
...
<div class="ct_topo_1">
    ...
    Editar Romaneio de Sa&iacute;da
    </div>
...
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/editar_4_enviar.php" method="post" />
...
<div style="height:60px; width:1270px; border:1px solid transparent; margin:auto; text-align:center">
	...
	<div id='centro' style='float:left; height:45px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form action='$servidor/$diretorio_servidor/estoque/saida/editar_2_selec_fornecedor.php' method='post'>
	...
	<div id='centro' style='float:left; height:45px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form action='$servidor/$diretorio_servidor/estoque/saida/editar_1_selec_produto.php' method='post'>
	...
	<form action='$servidor/$diretorio_servidor/estoque/saida/editar_1_selecionar.php' method='post'>
