...
<!-- ======= ESPAÇAMENTO ============================================================================================ -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/relatorio_selec_fornecedor.php" method="post" />
...
<div class="pqa_caixa">
    ...
    <div class="pqa_campo">
    <input type="text" name="nome_form" class="form_input" id="ok" value="<?php echo"$nome_form"; ?>" style="width:400px" />
    </div>
</div>
<!-- ================================================================================================================ -->
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/estoque/saida/relatorio_periodo.php' method='post'>
