...
"SELECT 
	...
	estoque.cod_tipo,
	estoque.quant_quebra_previsto,
	estoque.confirmacao_negocio
FROM 
	estoque,
	cadastro_pessoa,
	select_tipo_sacaria
WHERE 
	(estoque.numero_romaneio='$numero_romaneio' AND $mysql_movimentacao) AND 
...
$busca_permissao = mysqli_query ($conexao, "SELECT romaneio_editar, romaneio_editar_antigo, romaneio_nf_saida FROM usuarios_permissoes WHERE username='$username'");
...
<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px">
<div style="width:180px; margin-top:3px; margin-left:5px; float:left">N&ordm; Confirma&ccedil;&atilde;o:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$confirmacao_w" ?></div></div>
...
<div style='width:1165px; height:30px; margin:auto; border:1px solid transparent'>
    ...
    Quantidade: $soma_quantidade_nf_print $unidade_print_p</div>
...
<td width='360px' align='left'><div style='height:14px; margin-left:10px; overflow:hidden'>$produtor_nome_z</div></td>
<td width='120px' align='center'>$numero_nf_z</td>
<td width='160px' align='center'>$natureza_operacao_z</td>
...
<!-- ======= USUÁRIO CADASTRO, EDIÇÃO E EXCLUSÃO ================================================================= -->
<div style="width:auto; height:35px; margin:auto; border:1px solid transparent">
<?php
echo "
<div style='width:410px; height:30px; border:1px solid transparent; margin-top:0px; margin-left:40px; float:left'>
	<div style='width:405px; height:25px; float:left; border:1px solid transparent'>
	<div style='width:400px; height:25px; border:0px solid #999; float:left; color:#999; font-size:10px; text-align:center; background-color:#EEE'>
	<div style='width:395px; height:16px; margin-top:6px; margin-left:7px; text-align:left; overflow:hidden'><i>$dados_cadastro_w</i></div></div>
	</div>
</div>";

if (!empty($usuario_alteracao_w))
{echo "
<div style='width:410px; height:30px; border:1px solid transparent; margin-top:0px; margin-left:0px; float:left'>
	<div style='width:405px; height:25px; float:left; border:1px solid transparent'>
	<div style='width:400px; height:25px; border:0px solid #999; float:left; color:#999; font-size:10px; text-align:center; background-color:#EEE'>
	<div style='width:395px; height:16px; margin-top:6px; margin-left:7px; text-align:left; overflow:hidden'><i>$dados_alteracao_w</i></div></div>
	</div>
</div>";}
...
<div style='width:410px; height:30px; border:1px solid transparent; margin-top:0px; margin-left:0px; float:left'>
	<div style='width:405px; height:25px; float:left; border:1px solid transparent'>
	<div style='width:400px; height:25px; border:0px solid #999; float:left; color:#999; font-size:10px; text-align:center; background-color:#EEE'>
	<div style='width:395px; height:16px; margin-top:6px; margin-left:7px; text-align:left; overflow:hidden'><i>$dados_exclusao_w</i></div></div>
	</div>
</div>";}
?>
</div>
