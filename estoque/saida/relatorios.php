...
$pagina = 'relatorios';
$titulo = 'Estoque - Relat&oacute;rios de Sa&iacute;das';
$modulo = 'estoque';
$menu = 'saida';
// ================================================================================================================
...
<div style="width:1250px; height:315px; margin:auto; font-size:14px">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/nota_fiscal_saida/nf_relatorio_fornecedor_seleciona.php">
            &#8226; Relat&oacute;rio de Notas Fiscais de Sa&iacute;da</a>
			</div>
		</div>
