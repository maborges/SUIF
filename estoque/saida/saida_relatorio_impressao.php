...
$pagina = 'saida_relatorio_impressao';
...
<!-- ====================== -->
	...
	<div style='margin-top:5px'>ESTOQUE - ROMANEIOS DE SA&Iacute;DA<br /></div></div>
...
<div style='width:708px; border:0px solid #000; margin-top:1px; float:left; color:#FFF; font-size:9px; text-align:center'>
	...
	<div style='width:204px; height:15px; border:1px solid #000; float:left; background-color:#666'><div style='margin-top:2px'>Cliente</div></div>
...
if ($x_principal == $numero_paginas)
{
	...
	TOTAL DE SA&Iacute;DA: <b>$soma_romaneio_print Kg</b>
	</div>";
