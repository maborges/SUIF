...
<div class="pqa">
    ...
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/relatorio_romaneios_excluidos.php" method="post" />
...
<div class="contador">
	...
	<?php
	echo "<a href='$servidor/$diretorio_servidor/estoque/saida/excluir_romaneio_1.php'><button type='submit' class='botao_1'>Excluir Romaneio</button></a>";	
	if ($linha_romaneio >= 1)
	{echo"
	<form action='$servidor/$diretorio_servidor/estoque/saida/relatorio_romaneios_excluidos_impressao.php' target='_blank' method='post'>
