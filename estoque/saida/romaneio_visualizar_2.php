...
// ====== BUSCA ROMANEIO ==========================================================================================
$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE numero_romaneio='$numero_romaneio_busca' AND movimentacao='SAIDA' ORDER BY codigo");
...
{
header ("Location: $servidor/$diretorio_servidor/estoque/saida/romaneio_nao_localizado.php");
exit;
}
// ================================================================================================================
...
$confirmacao_negocio = $num_romaneio_manual;
...
// ====== SOMA NOTAS FISCAIS ======================================================================
$soma_nota_fiscal = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM nota_fiscal_saida WHERE estado_registro!='EXCLUIDO' AND codigo_romaneio='$numero_romaneio_busca'"));
...
elseif ($situacao_romaneio == "EM_ABERTO")
{$msg = "<div style='color:#444'>Romaneio de Sa&iacute;da Em Aberto</div>";
$msg_2 = "<div style='color:#444'></div>";}

else
{$msg = "<div style='color:#009900'>Romaneio de Sa&iacute;da</div>";
...
<!-- ====== BOTAO VOLTAR ======================================================================================================== -->
	<div style="float:left; width:46px; border:0px solid #000">
        ...
        <input type='image' src='<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/icones/icone_voltar.png' height='20px' border='0' title='Voltar' />
        </form>	
	</div>
<!-- ============================================================================================================================= -->
...
<!-- ====== BOTAO FINALIZAR  ===================================================================================================== -->
    ...
    {	
        echo "
        <form action='$servidor/$diretorio_servidor/estoque/saida/finalizar_1_formulario.php' method='post'>
        ...
        <input type='image' src='$servidor/$diretorio_servidor/imagens/icones/icone_balanca_2.png' height='20px' border='0' title='Finalizar' />
        </form>";
    }
    
    else
    {
        echo "<input type='image' class='preto_branco' src='$servidor/$diretorio_servidor/imagens/icones/icone_balanca_2.png' height='20px' border='0' />";
    }
...
<!-- ====== BOTAO EDITAR ========================================================================================================= -->
    ...
    {	
		...
		<input type='hidden' name='situacao_romaneio_busca' value='$situacao_romaneio_busca'>
		<input type='hidden' name='forma_pesagem_busca' value='$forma_pesagem_busca'>
        <input type='image' src='$servidor/$diretorio_servidor/imagens/icones/icone_editar_2.png' height='20px' border='0' title='Editar' />
        </form>";
    }
    ...
    {
        echo "<input type='image' class='preto_branco' src='$servidor/$diretorio_servidor/imagens/icones/icone_editar_2.png' height='20px' border='0' />";
    }
    ?>
	</div>
<!-- ============================================================================================================================= -->
...
<!-- ====== BOTAO NOTA FISCAL ==================================================================================================== -->
    ...
    {	
        ...
        <input type='hidden' name='numero_romaneio' value='$numero_romaneio'>
        <input type='hidden' name='numero_romaneio_busca' value='$numero_romaneio_busca'>
        <input type='image' src='$servidor/$diretorio_servidor/imagens/icones/icone_doc_1.png' height='20px' border='0' title='Nota Fiscal' />
        </form>";
    }
    
    else
    {
        echo "<input type='image' class='preto_branco' src='$servidor/$diretorio_servidor/imagens/icones/icone_doc_1.png' height='20px' border='0' />";
    }
    ?>
	</div>
<!-- ============================================================================================================================= -->
...
<!-- ====== BOTAO IMPRIMIR ======================================================================================================= -->
    ...
    {	
        ...
        <input type='image' src='$servidor/$diretorio_servidor/imagens/icones/icone_imprimir.png' height='20px' border='0' title='Imprimir' />
        </form>";
    }
    
    else
    {
        echo "<input type='image' class='preto_branco' src='$servidor/$diretorio_servidor/imagens/icones/icone_imprimir.png' height='20px' border='0' />";
    }
    ?>
	</div>
<!-- ============================================================================================================================= -->
...
<!-- ================================================= DADOS DO ROMANEIO ============================================================================= -->
			...
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">N&ordm; Romaneio Manual:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$num_romaneio_manual" ?></div></div>
			...
			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px; background-color:#EEE">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Tipo Sacaria:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$descricao_sacaria" ?></div></div>

			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:35px; background-color:#EEE">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Filial Origem:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$filial_origem" ?></div></div>
			...
			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Quantidade Sacaria:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$quant_sacaria" ?></div></div>

			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:35px">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Motorista:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$motorista" ?></div></div>
		

			<div style="width:1025px; height:3px; border:0px solid #000; float:left; font-size:12px"></div>
			
			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px; background-color:#EEE">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Desc. Previsto (Qualidade):</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$desconto_previsto Kg" ?></div></div>

			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:35px; background-color:#EEE">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">CPF Motorista:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$motorista_cpf" ?></div></div>
			...
			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">N&ordm; Confirma&ccedil;&atilde;o:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$confirmacao_negocio" ?></div></div>

			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:35px">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Placa do Ve&iacute;culo:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$placa_veiculo" ?></div></div>
			...
			<div style="margin-top:3px; margin-left:5px; width:650px; height:14px; float:left; border:0px solid #000; overflow:hidden"><?php echo"$observacao" ?></div></div>
...
<div id="tabela_2" style="width:1055px; height:20px; border:0px solid #000; font-size:12px; margin-top:15px">
	<div style="width:600px; margin-left:25px; color:#003466; float:left; border:0px solid #000">Notas Fiscais de Sa&iacute;da:</div>
