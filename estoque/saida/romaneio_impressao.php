...
$titulo = "Romaneio de Sa&iacute;da";
$modulo = "estoque";
$menu = "saida";
// ================================================================================================================
...
$mysql_movimentacao = "estoque.movimentacao='SAIDA'";
// ================================================================================================================
...
$peso_bruto = ($peso_final_w - $peso_inicial_w);
...
if (!empty($confirmacao_w) or $confirmacao_w == 0)
{$confirmacao_w = "";}
...
<div style="width:730px; height:40px; border:0px solid #000; margin-left:25px; font-size:17px; float:left" align="center"></div>

<div style="width:730px; height:80px; border:0px solid #000; margin-left:25px; font-size:17px; float:left" align="left">
	<div style="width:355px; height:80px; border:0px solid #000; font-size:17px; float:left" align="left">
	<img src="<?php echo"$servidor/$diretorio_servidor"; ?>/imagens/logomarca_pb.png" height="80px" border="0" />
    </div>
	<div style="width:355px; height:50px; border:0px solid #000; font-size:26px; margin-top:20px; float:right" align="right">
	Romaneio de Sa&iacute;da
    </div>
</div>

<div style="width:730px; height:50px; border:0px solid #000; margin-left:25px; font-size:17px; float:left" align="center">

    <div style="width:235px; height:20px; border:0px solid #000; font-size:18px; float:left" align="left"><?php echo"$data_print"; ?></div>
    <div style="width:235px; height:20px; border:0px solid #000; font-size:18px; float:left" align="center">
    <?php echo $msg_situacao; ?></div>
    <div style="width:235px; height:40px; border:0px solid #000; font-size:18px; float:right" align="right">N&ordm; <?php echo"$numero_romaneio"; ?></div>

    <div style="width:235px; height:20px; border:0px solid #000; font-size:14px; float:left" align="left"><?php // echo"$hora_cadastro"; ?></div>
    <div style="width:235px; height:20px; border:0px solid #000; font-size:14px; float:left" align="center">
...
<div id="tabela_2" style="width:730px; height:50px; border:1px solid #000; color:#000; border-radius:0px; overflow:hidden; float:left">
    ...
    <div style="margin-top:3px; margin-left:25px; float:left">Nome:</div><div style="margin-top:3px; margin-left:5px; float:left">
	<?php echo"<b>$pessoa_nome_w</b>" ?></div></div>
	...
	<?php echo"<b>$pessoa_cpf_cnpj</b>" ?></div></div>

    <div style="width:720px; height:5px; border:0px solid #000; float:left; font-size:12px"></div>

    <div style="width:500px; height:15px; border:0px solid #000; float:left; font-size:12px">
    <div style="margin-top:3px; margin-left:25px; float:left">Cidade:</div><div style="margin-top:3px; margin-left:5px; float:left">
	<?php echo"<b>$pessoa_cidade_w / $pessoa_estado_w</b>" ?></div></div>

    <div style="width:225px; height:15px; border:0px solid #000; float:left; font-size:12px">
    <div style="margin-top:3px; margin-left:5px; float:left">Telefone:</div><div style="margin-top:3px; margin-left:5px; float:left">
	<?php echo"<b>$pessoa_telefone_w</b>" ?></div></div>
...
<div id="tabela_2" style="width:730px; height:330px; border:0px solid #000; color:#000; overflow:hidden; float:left">
    ...
    <div style="margin-top:5px"><?php echo"$peso_inicial_print" ?></div></div>
    ...
    <div style="margin-top:5px"><?php echo"$peso_final_print" ?></div></div>
    <div style="width:103px; height:25px; border:1px solid #000; border-radius:0px; float:left; font-size:12px; text-align:center; margin-left:20px">
    <div style="margin-top:5px"><?php echo"$peso_bruto_print" ?></div></div>
    <div style="width:103px; height:25px; border:1px solid #000; border-radius:0px; float:left; font-size:12px; text-align:center; margin-left:20px">
    <div style="margin-top:5px"><?php echo"$desconto_sacaria_print" ?></div></div>
    <div style="width:103px; height:25px; border:1px solid #000; border-radius:0px; float:left; font-size:12px; text-align:center; margin-left:20px">
    <div style="margin-top:5px"><?php echo"$desconto_print" ?></div></div>
    <div style="width:103px; height:25px; border:1px solid #000; border-radius:0px; float:left; font-size:12px; text-align:center; margin-left:20px">
    <div style="margin-top:5px"><?php echo"$quantidade_print" ?></div></div>
...
<!-- ======= DADOS DO ROMANEIO ====================================================================================================== -->
    ...
    <div style="width:330px; height:26px; border-bottom:1px solid #000; float:left; font-size:12px; margin-left:25px">
    	...
    	<div style="margin-top:7px; margin-left:0px; float:left"><?php echo"$confirmacao_w" ?></div>
	</div>
...
<div style="width:710px; height:10px; border:0px solid #000; font-size:17px; float:left" align="center"></div>
	...
	<div style="width:160px; height:10px; border:0px solid #000; font-size:11px; float:left; margin-left:20px" align="center">Cliente</div>
