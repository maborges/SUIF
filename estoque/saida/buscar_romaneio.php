...
<!-- ================================================================================================================ -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/romaneio_visualizar_2.php" method="post" />
...
<div class="pqa_caixa">
    ...
    <div class="pqa_campo">
    <input type="text" name="numero_romaneio_busca" class="pqa_input" id="ok" maxlength="10" 
