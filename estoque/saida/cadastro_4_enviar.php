...
if ($botao == "NOVO_ROMANEIO")
{
	...
	$msg_titulo = "<div style='color:#009900'>Novo Romaneio de Sa&iacute;da</div>";
...
// ====== BOTAO VOLTAR =========================================================================================================
	...
	<div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form name='voltar' action='$servidor/$diretorio_servidor/estoque/saida/cadastro_3_formulario.php' method='post'>
