...
<div class="ct_topo_2">
	...
	<?php 
		...
		{echo"<div style='height:28px; width:640px; border:0px solid #000; color:#003466; float:left'>Cliente: <b> $forne_print</b></div>";}
	?>
    </div>
...
<div class="pqa">
	...
	{echo "<option value='ENTRADA_DIRETA' selected='selected'>Sa&iacute;da Direta</option>";}
	else
	{echo "<option value='ENTRADA_DIRETA'>Sa&iacute;da Direta</option>";}
    ?>
    </select>
	</div>
...
<div class="contador">
	...
	<?php
	if ($permissao[17] == "S")
	{echo "<a href='$servidor/$diretorio_servidor/estoque/saida/cadastro_1_selec_produto.php'>
	...
	if ($linha_romaneio >= 1)
	{echo"
	<form action='$servidor/$diretorio_servidor/estoque/saida/saida_relatorio_impressao.php' target='_blank' method='post'>
