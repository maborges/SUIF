...
$pagina = "index_saida";
$titulo = "Romaneios de Sa&iacute;da";
$modulo = "estoque";
$menu = "saida";
// ================================================================================================================
...
{$msg = "Cliente: <b>$nome_fornecedor</b>";}
// ================================================================================================================
// ================================================================================================================
...
<!-- ================================================================================================================ -->
<div class="pqa_caixa">
<form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/relatorio_periodo.php" method="post" />
...
<div class="pqa_caixa" style="float:right">
	...
	if ($linha_romaneio >= 1)
    {echo"
	<form action='$servidor/$diretorio_servidor/estoque/saida/relatorio_selec_fornecedor.php' method='post' />
	<input type='hidden' name='botao' value='BUSCAR'>
	...
	<button type='submit' class='botao_1' style='float:right'>Filtrar por Cliente</button>
	</form>";}
	?>
    </div>
</div>
...
<div class="pqa_caixa" style="float:right">
	...
	if ($linha_romaneio >= 1)
    {echo"
	<form action='$servidor/$diretorio_servidor/estoque/saida/buscar_romaneio.php' method='post' />
