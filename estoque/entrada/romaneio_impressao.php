...
// ====== BUSCA NOTAS FISCAIS ======================================================================
$busca_nota_fiscal = mysqli_query ($conexao, "SELECT nota_fiscal_entrada.codigo, nota_fiscal_entrada.codigo_romaneio, nota_fiscal_entrada.codigo_fornecedor, nota_fiscal_entrada.numero_nf, nota_fiscal_entrada.data_emissao, nota_fiscal_entrada.valor_unitario, nota_fiscal_entrada.unidade, nota_fiscal_entrada.quantidade, nota_fiscal_entrada.valor_total, nota_fiscal_entrada.observacao, nota_fiscal_entrada.usuario_cadastro, nota_fiscal_entrada.hora_cadastro, nota_fiscal_entrada.data_cadastro, nota_fiscal_entrada.usuario_alteracao, nota_fiscal_entrada.hora_alteracao, nota_fiscal_entrada.data_alteracao, nota_fiscal_entrada.estado_registro, nota_fiscal_entrada.filial, nota_fiscal_entrada.natureza_operacao, cadastro_pessoa.nome, cadastro_pessoa.tipo, cadastro_pessoa.cpf, cadastro_pessoa.cnpj FROM nota_fiscal_entrada, cadastro_pessoa WHERE nota_fiscal_entrada.estado_registro='ATIVO' AND nota_fiscal_entrada.codigo_romaneio='$numero_romaneio' AND nota_fiscal_entrada.codigo_fornecedor=cadastro_pessoa.codigo ORDER BY nota_fiscal_entrada.data_emissao");
...
<div style="margin-top:0px; margin-left:25px">Fornecedor:</div></div>
