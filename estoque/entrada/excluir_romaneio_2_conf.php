...
// ====== BUSCA ROMANEIO ==========================================================================================
$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE numero_romaneio='$num_romaneio_form' AND movimentacao='ENTRADA' ORDER BY codigo");
...
// ====== BUSCA ENTRADA =================================================================================
$busca_entrada = mysqli_query ($conexao, "SELECT * FROM compras WHERE estado_registro!='EXCLUIDO' AND numero_romaneio='$num_romaneio_form' ORDER BY codigo");
...
// ====== SOMA NOTAS FISCAIS ======================================================================
$soma_nota_fiscal = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(valor_total) FROM nota_fiscal_entrada WHERE estado_registro!='EXCLUIDO' AND codigo_romaneio='$num_romaneio_form'"));
...
if ($permissao[64] == "S" and $linha_entrada == 0 and $pode_excluir == "S" and $estado_registro == "ATIVO")
{$permite_excluir = "SIM";}
else
{$permite_excluir = "NAO";}
// ========================================================================================================
...
<!-- ============================================================================================================= -->
<div class="ct_topo_1" style="width:1450px">
	<div class="ct_titulo_1" style="margin-left:0px">
    <?php echo "$titulo"; ?>
    </div>

	<div class="ct_subtitulo_right" style="margin-right:0px">
...
<!-- ============================================================================================================= -->
<div class="ct_topo_2" style="width:1450px">
	<div class="ct_subtitulo_left" style="margin-left:0px; color:#FF0000">
    <?php echo "$msg"; ?>
    </div>
...
if ($erro == 0)
{
    ...
    <form action='$servidor/$diretorio_servidor/estoque/entrada/excluir_romaneio_3_enviar.php' method='post'>
...
<div id="centro" style="height:50px; width:1270px; border:0px solid #999; margin:auto; text-align:center">
	...
	<?php
		...
		echo "
			...
			<form action='$servidor/$diretorio_servidor/estoque/entrada/excluir_romaneio_1.php' method='post'>
			<input type='hidden' name='num_romaneio_form' value='$num_romaneio_form'>
