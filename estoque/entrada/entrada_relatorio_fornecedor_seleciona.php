...
$pagina = 'entrada_relatorio_fornecedor_seleciona';
...
<div class="pqa">
    ...
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/entrada/entrada_relatorio_fornecedor_seleciona.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/estoque/entrada/entrada_relatorio_fornecedor.php' method='post'>
