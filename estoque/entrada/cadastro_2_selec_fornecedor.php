...
<body onload="javascript:foco('ok');">
	...
	<div class="ct_1">
		...
		<div class="pqa">
			...
			<form action="<?php echo "$servidor/$diretorio_servidor"; ?>/estoque/entrada/cadastro_2_selec_fornecedor.php" method="post" />
		...
		for ($x = 1; $x <= $linha_pessoa_geral; $x++) {
			...
			echo "
				...
				<td width='450px' height='24px' align='left'>
					...
					<form action='$servidor/$diretorio_servidor/estoque/entrada/cadastro_3_formulario.php' method='post'>
		...
		// =================================================================================================================
		if ($linha_pessoa_geral == 0 and ($nome_form != '' or $cpf_cnpj_x != '')) {
			echo "
