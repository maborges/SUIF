...
// ====== BUSCA PRODUTO ===================================================================================
/*
$busca_produto = mysqli_query ($conexao, "SELECT descricao FROM cadastro_produto WHERE codigo='$cod_produto' AND estado_registro!='EXCLUIDO'");
...
// ====== BUSCA ENTRADA =================================================================================
$busca_entrada = mysqli_query ($conexao, "SELECT numero_compra FROM compras WHERE estado_registro!='EXCLUIDO' AND numero_romaneio='$numero_romaneio' ORDER BY codigo");
...
{$num_registro_entrada = $aux_busca_entrada[0];}
// ======================================================================================================
