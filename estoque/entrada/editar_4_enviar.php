...
$achou_romaneio_duplicidade = $_POST["achou_romaneio_duplicidade"] ?? '';
...
$quant_volume = round($quantidade / $quant_kg_saca);
// ================================================================================================================
...
if ($botao == "EDITAR_ROMANEIO") {
	if ($fornecedor_form == "" or $linhas_fornecedor == 0) {
		...
		$msg_titulo = "<div style='color:#009900'>Editar Romaneio de Entrada</div>";
...
<body onload="javascript:foco('ok');">
	...
	<div class="ct_1" style="height:560px">
		...
		<!-- ============================================================================================================= -->
		<div style="height:40px; border:0px solid #000">
			<div class="ct_subtitulo_1" style="float:left; text-align:left">
				<?php echo "$msg"; ?>
			</div>

			<div class="ct_subtitulo_1" style="float:right; text-align:right; font-style:normal">
				<?php echo "$data_hoje"; ?>
			</div>
		</div>
		<!-- ============================================================================================================= -->
...
";
	...
	<div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form name='voltar' action='$servidor/$diretorio_servidor/estoque/entrada/editar_3_formulario.php' method='post'>
