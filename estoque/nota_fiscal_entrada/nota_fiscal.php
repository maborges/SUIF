...
if ($botao == "INCLUIR_NF")
{
	...
	{
	$inserir = mysqli_query ($conexao, "INSERT INTO nota_fiscal_entrada (codigo, codigo_romaneio, codigo_fornecedor, numero_nf, data_emissao, valor_unitario, unidade, quantidade, valor_total, observacao, usuario_cadastro, hora_cadastro, data_cadastro, estado_registro, filial, fornecedor_print, cod_produto, codigo_fornecedor_romaneio, fornecedor_romaneio_print, natureza_operacao) VALUES (NULL, '$numero_romaneio', '$fornecedor_nf', '$numero_nf', '$data_emissao_nf', '$valor_unitario_nf', '$unidade_nf', '$quantidade_nf', '$valor_total_nf', '$observacao_nf', '$usuario_cadastro_nf', '$hora_cadastro_nf', '$data_cadastro_nf', 'ATIVO', '$filial_nf', '$fornecedor_print_nf', '$cod_produto', '$fornecedor', '$fornecedor_print', '$natureza_operacao_nf')");
...
{
$excluir_nf = mysqli_query ($conexao, "UPDATE nota_fiscal_entrada SET estado_registro='EXCLUIDO', usuario_exclusao='$usuario_alteracao_nf', hora_exclusao='$hora_alteracao_nf', data_exclusao='$data_alteracao_nf', motivo_exclusao='$motivo_exclusao_nf' WHERE codigo='$codigo_nf'");
...
<div class="form" style="height:28px; border:1px solid transparent">
	...
	<div style="width:174px; height:auto; float:left; border:1px solid transparent">
    <input type="text" class="form_input" name="quantidade" maxlength="11" onkeypress="mascara(this,mvalor)" 
    ...
    onkeydown="if (getKey(event) == 13) return false;" style="width:150px; text-align:left; padding-left:5px" value="<?php echo"$observacao_nf"; ?>" />
    </div>
...
$quantidade_print = number_format($quantidade_w,0,",",".") . " " . $unidade_print_p;
...
<td width='120px' align='center'>$numero_nf_w</td>
