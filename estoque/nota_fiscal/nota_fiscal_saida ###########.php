...
<input type="text" name="data_emissao" value='<?php $hoje = date ("d/m/Y", time()); echo "$hoje"; ?>' size='14' maxlength='10' onkeypress='mascara(this,data)' onkeydown='if (getKey(event) == 13) return false;' style="color:#0000FF; width:145px; font-size:12px" />
</div>
...
<!-- =================================  QUANTIDADE ====================================== -->
<div id="tabela_2" style="width:150px; border:0px solid #000">
<input type="text" name="quantidade" maxlength="15" onkeypress="troca(this)" onkeydown="if (getKey(event) == 13) return false;" style="color:#0000FF; width:145px; font-size:12px; text-align:center" />
</div>
