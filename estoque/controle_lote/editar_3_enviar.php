...
$quant_bag_form = Helpers::ConvertePeso($_POST["quant_bag_form"], 'N');
$peso_bag_form = Helpers::ConvertePeso($_POST["peso_bag_form"], 'N');
...
// ====== BUSCA PESSOA ===================================================================================
$busca_fornecedor = mysqli_query ($conexao, "SELECT * FROM cadastro_pessoa WHERE codigo='$cod_fornecedor_form' AND estado_registro!='EXCLUIDO'");
...
if ($botao == "EDITAR_2")
{
	...
	{$erro = 0;
	$msg = "";
	$msg_titulo = "<div style='color:#0000FF'>Movimenta&ccedil;&atilde;o interna editada com sucesso!</div>";
	$num_movimentacao_print = "<div style='color:#0000FF'>N&ordm; $numero_movimentacao</div>";

	$editar = mysqli_query ($conexao, "UPDATE estoque_lote SET cod_tipo_producao='$tipo_prod_form', umidade='$umidade_form', densidade='$densidade_form', impureza='$impureza_form', broca='$broca_form', usuario_alteracao='$usuario_alteracao', data_alteracao='$data_alteracao', hora_alteracao='$hora_alteracao' WHERE numero_movimentacao='$numero_movimentacao'");

//	$editar = mysqli_query ($conexao, "UPDATE estoque_lote SET tipo_movimentacao='$movimentacao_form', cod_lote='$lote_form', nome_lote='$lote_descricao', peso='$peso', unidade_medida='$un_aux', numero_romaneio='$numero_romaneio_form', cod_produto='$cod_produto_form', nome_produto='$produto_print', cod_tipo_producao='$tipo_prod_form', cod_fornecedor='$cod_fornecedor_form', nome_fornecedor='$fornecedor_print', cod_armazem='$cod_armazem', quantidade_bag='$quant_bag', cod_sacaria='$cod_sacaria', umidade='$umidade_form', densidade='$densidade_form', impureza='$impureza_form', broca='$broca_form', filial='$filial', usuario_alteracao='$usuario_alteracao', data_alteracao='$data_alteracao', hora_alteracao='$hora_alteracao' WHERE numero_movimentacao='$numero_movimentacao'");
...
<!-- =============================================== DADOS DA MOVIMENTAÇÃO ============================================================================= -->
	...
	{echo"<div style='width:153px; height:25px; border:1px solid #999; float:left; font-size:12px; text-align:center; margin-left:21px; background-color:#EEE'>
	<div style='margin-top:4px; width:150px; height:16px; text-align:center; overflow:hidden'>$quant_bag_print Kg</div></div>";}
...
// ====== BOTAO VOLTAR =========================================================================================================
	...
	<div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form name='voltar' action='$servidor/$diretorio_servidor/estoque/controle_lote/editar_2_formulario.php' method='post'>
	...
	<input type='hidden' name='cod_fornecedor_form' value='$cod_fornecedor_form' />
