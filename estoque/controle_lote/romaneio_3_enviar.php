...
$peso_form = Helpers::ConvertePeso($_POST["peso_form"], 'N');
...
if ($botao == "NOVA_MOVIMENTACAO")
{
	...
	elseif ($peso_form == "" or $peso_form <= 0 or !is_numeric($peso))
	{$erro = 6;
...
*/
	...
	$inserir = mysqli_query ($conexao, "INSERT INTO estoque_lote (id, numero_movimentacao, tipo_movimentacao, data, cod_lote, nome_lote, peso, unidade_medida, numero_romaneio, cod_produto, nome_produto, cod_tipo_producao, cod_fornecedor, nome_fornecedor, cod_armazem, quantidade_bag, cod_sacaria, umidade, densidade, impureza, broca, filial, usuario_cadastro, data_cadastro, hora_cadastro, estado_registro, peso_bag) VALUES (NULL, '$numero_movimentacao', '$movimentacao_form', '$data_hoje', '$lote_form', '$lote_descricao', '$peso', '$un_aux', '$numero_romaneio_form', '$cod_produto_form', '$produto_print', '$tipo_prod_form', '$fornecedor_form', '$fornecedor_print', '$cod_armazem', '$quant_bag', '$cod_sacaria', '$umidade_form', '$densidade_form', '$impureza_form', '$broca_form', '$filial', '$usuario_cadastro', '$data_cadastro', '$hora_cadastro', '$estado_registro', '$peso_bag')");
...
// ======================================================================================================
$peso_print = number_format($peso,0,",",".");
...
<!-- =============================================== DADOS DA MOVIMENTAÇÃO ============================================================================= -->
    ...
    <div style="width:153px; height:20px; border:1px solid #FFF; border-radius:5px; float:left; font-size:12px; text-align:center; margin-left:21px">
    <div style="margin-top:5px">Peso</div></div>
    <div style="width:153px; height:20px; border:1px solid #FFF; border-radius:5px; float:left; font-size:12px; text-align:center; margin-left:21px">
    <div style="margin-top:5px">Tipo do Produto</div></div>
    <div style="width:153px; height:20px; border:1px solid #FFF; border-radius:5px; float:left; font-size:12px; text-align:center; margin-left:21px">
    <div style="margin-top:5px">Umidade</div></div>
    ...
    <div style="margin-top:5px">Impureza</div></div>
...
<!-- ============================================================================================================== -->
    ...
    <div style="width:153px; height:18px; border:1px solid #FFF; border-radius:5px; float:left; font-size:12px; text-align:center; margin-left:21px">
    <div style="margin-top:3px"><!-- Quantidade de Bag --></div></div>
    <div style="width:153px; height:18px; border:1px solid #FFF; border-radius:5px; float:left; font-size:12px; text-align:center; margin-left:21px">
...
// ====== BOTAO VOLTAR =========================================================================================================
	...
	<div id='centro' style='float:left; height:55px; width:200px; color:#00F; text-align:center; border:0px solid #000'>
	<form name='voltar' action='$servidor/$diretorio_servidor/estoque/controle_lote/romaneio_2_formulario.php' method='post'>
