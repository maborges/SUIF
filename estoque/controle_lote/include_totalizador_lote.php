...
$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(peso) FROM estoque_lote WHERE estado_registro!='EXCLUIDO' AND $mysql_filtro_data AND cod_lote='$codigo_lote_w' AND filial='$filial' AND cod_produto='$aux_bp_geral[0]'"));
