...
$pagina = 'nf_relatorio_fornecedor_seleciona';
...
<div class="ct_topo_1">
    ...
    Relat&oacute;rio de Notas Fiscais de Sa&iacute;da de Sa&iacute;da
    </div>
...
<div class="ct_topo_2">
	...
	<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/relatorios.php">&#8226; Outros relat&oacute;rios Sa&iacute;da</a>
    </div>
</div>
<!-- ============================================================================================================= -->
...
<div class="pqa">
    ...
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/nota_fiscal_saida/nf_relatorio_fornecedor_seleciona.php" method="post" />
...
// ====== RELATORIO ========================================================================================
	...
	<td width='450px' height='24px' align='left'>
		...
		<form action='$servidor/$diretorio_servidor/estoque/nota_fiscal_saida/nf_relatorio_fornecedor.php' method='post'>
		<input type='hidden' name='fornecedor_busca' value='$aux_pessoa[0]'>
		<input type='hidden' name='seleciona_pessoa' value='NOTA_FISCAL'>
...
{echo "
<div id='centro' style='height:30px; width:700px; border:0px solid #000; color:#F00; font-size:12px; margin:auto; text-align:center'><i>Nenhum produtor encontrado.</i></div>";}
else
{}
// =================================================================================================================
