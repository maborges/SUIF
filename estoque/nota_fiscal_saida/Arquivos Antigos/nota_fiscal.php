...
$situacao_romaneio_form = $_POST["situacao_romaneio_form"];
$forma_pesagem_form = $_POST["forma_pesagem_form"];

$numero_romaneio_w = $_POST["numero_romaneio_w"];

$filial_nf = $filial_usuario;
$numero_romaneio = $_POST["numero_romaneio_w"];
$num_romaneio_aux = $_POST["numero_romaneio_w"];
...
<!-- ============================================================================================================= -->
<div id="centro" style="height:200px; width:1080px; border:0px solid #0000FF; margin:auto">
...
<!-- ===================== DADOS DO FORNECEDOR ============================================================================= -->
	...
	<div style="margin-top:0px; margin-left:55px; color:#003466">Cliente</div></div>
		<div id="centro" style="width:1030px; height:50px; border:1px solid #999; color:#003466; border-radius:0px; overflow:hidden; margin-left:25px; background-color:#EEE">
			...
			<div style="margin-top:3px; margin-left:5px; float:left">Nome:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<b>$fornecedor_print</b> ($fornecedor)" ?></div></div>
...
<!-- ============================================================================================================= -->
<div class="ct_topo_1">
	<div class="ct_titulo_1" style="width:545px; float:left; text-align:left; border:0px solid #000; color:#00F">
    Cadastro de Nota Fiscal de Sa&iacute;da
    </div>

	<div class="ct_titulo_1" style="width:545px; float:right; text-align:right; border:0px solid #000; color:#00F">
    ...
    <input type='hidden' name='numero_romaneio_w' value='<?php echo"$numero_romaneio_w"; ?>'>
    ...
    <input type='hidden' name='situacao_romaneio_form' value='<?php echo"$situacao_romaneio_form"; ?>'>
    <input type='hidden' name='numero_romaneio_form' value='<?php echo"$numero_romaneio_form"; ?>'>
    <input type='hidden' name='forma_pesagem_form' value='<?php echo"$forma_pesagem_form"; ?>'>
