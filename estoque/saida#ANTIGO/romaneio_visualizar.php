...
<div style="width:1080px; height:30px; border:0px solid #000; margin:auto">
	<div id="titulo_form_1" style="width:460px; height:30px; float:left; border:0px solid #000; margin-left:25px">
    Romaneio de Sa&iacute;da
    </div>

	<div id="titulo_form_1" style="width:460px; height:30px; float:right; border:0px solid #000; text-align:right; margin-right:25px">
...
<div style="width:1080px; height:20px; border:0px solid #000; margin:auto">
	<div id="titulo_form_2" style="width:460px; height:20px; float:left; border:0px solid #000; margin-left:25px; font-size:14px">
	</div>

	<div style="width:460px; height:20px; float:right; border:0px solid #000; text-align:right; margin-right:25px; font-size:16px; color:#003466">
	<?php echo"$data_print"; ?>
    </div>
</div>
<!-- ============================================================================================================= -->
...
<!-- ============================================================================================================= -->
<div id="centro" style="height:490px; width:1080px; border:0px solid #0000FF; margin:auto">


<!-- ===================== DADOS DO FORNECEDOR ============================================================================= -->
	<div id="tabela_2" style="width:1030px; height:20px; border:0px solid #000; font-size:12px; margin-top:0px">
	<div style="margin-top:0px; margin-left:55px; color:#003466">Cliente</div></div>
		<div id="centro" style="width:1030px; height:50px; border:1px solid #999; color:#003466; border-radius:0px; overflow:hidden; margin-left:25px; background-color:#EEE">
			...
			<div style="width:670px; height:15px; border:0px solid #000; float:left; font-size:12px; margin-left:25px; color:#003466">
			<div style="margin-top:3px; margin-left:5px; float:left">Cidade:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"<b>$cidade_fornecedor - $estado_fornecedor</b>" ?></div></div>
			<div style="width:300px; height:15px; border:0px solid #000; float:left; font-size:12px; color:#003466">
...
<!-- ================================================= PRODUTO ============================================================================= -->
	<div id="tabela_2" style="width:1030px; height:20px; border:0px solid #000; font-size:12px; margin-top:18px">
...
<!-- =============================================== DADOS DO ROMANEIO ============================================================================= -->
		<div id="centro" style="width:1055px; height:280px; border:0px solid #999; color:#003466; border-radius:5px; overflow:hidden; margin-left:25px">

			<div style="width:1025px; height:15px; border:0px solid #000; float:left; font-size:12px"></div>
...
<!-- ================================================= DADOS DO ROMANEIO ============================================================================= -->
			...
			<div style="width:470px; height:22px; border:0px solid #000; float:left; font-size:12px; margin-left:25px; background-color:#EEE">
			<div style="width:180px; margin-top:3px; margin-left:5px; float:left">Tipo Sacaria:</div><div style="margin-top:3px; margin-left:5px; float:left"><?php echo"$descrisao_sacaria" ?></div></div>
...
<div id="tabela_2" style="width:1055px; height:20px; border:0px solid #000; font-size:12px; margin-top:25px">
	<div style="width:800px; margin-left:25px; color:#003466; float:left; border:0px solid #000">Notas Fiscais de Sa&iacute;da:</div>
...
<td width='380px' align='center' bgcolor='#006699'>Cliente</td>
...
if ($situacao_romaneio == "PRE_ROMANEIO")
{
	echo "
		<div id='centro' style='float:left; height:55px; width:185px; color:#00F; text-align:center; border:0px solid #000'>
		<form action='$servidor/$diretorio_servidor/estoque/saida/romaneio_pre_impressao.php' method='post' target='_blank'>
		<input type='hidden' name='numero_romaneio' value='$numero_romaneio'>
		<input type='hidden' name='num_romaneio_aux' value='$num_romaneio_aux'>
		<input type='hidden' name='numero_compra' value='$numero_compra'>
...
<div id="centro" style="width:1030px; height:30px; border:0px solid #999; margin-left:25px"></div>
...
<div id="centro" style="width:1030px; height:20px; border:0px solid #999; margin-left:25px"></div>
