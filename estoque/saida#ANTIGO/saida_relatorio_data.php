...
if ($status_romaneio == "GERAL")
{
	...
	AND data='$data_inicial' AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) AND filial='$filial' ORDER BY codigo");
	...
	AND movimentacao='SAIDA' AND data='$data_inicial' AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) AND filial='$filial'"));
	...
	{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' 
	AND data='$data_inicial' AND situacao='SAIDA_DIRETA' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao='SAIDA_DIRETA' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	}
	...
	{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' 
	AND data='$data_inicial' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	}
}
...
else
{
	...
	{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' 
	AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' 
	AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	}
	...
	{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' 
	AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' AND situacao='SAIDA_DIRETA' 
	AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' 
	AND situacao='SAIDA_DIRETA' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	}
	...
	{
	$busca_romaneio = mysqli_query ($conexao, "SELECT * FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' 
	AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' AND filial='$filial' ORDER BY codigo");
	$linha_romaneio = mysqli_num_rows ($busca_romaneio);
	$soma_romaneio = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' AND filial='$filial'"));
	$soma_romaneio_print = number_format($soma_romaneio[0],2,",",".");
	}
}
// ================================================================================================================
...
<div id="centro" style="height:36px; width:1250px; border:0px solid #000; margin:auto; background-color:#708090">
    ...
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/saida_relatorio_data.php" method="post" />
    ...
    <div id="centro" style="height:20px; width:50px; border:0px solid #999; color:#FFF; font-size:11px; float:left; text-align:left; margin-top:11px">
        <i>Data:&#160;</i>
    </div>
...
if ($status_romaneio == "GERAL")
{
	...
	AND movimentacao='SAIDA' AND data='$data_inicial' AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) 
	AND cod_produto='$aux_bp_geral[0]' AND filial='$filial'"));
	...
	{
	$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao='SAIDA_DIRETA' AND cod_produto='$aux_bp_geral[0]' 
	AND filial='$filial'"));
	$soma_quant_print = number_format($soma_quant_produto[0],2,",",".");
	}
	...
	{
	$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND cod_produto='$aux_bp_geral[0]' AND filial='$filial'"));
	$soma_quant_print = number_format($soma_quant_produto[0],2,",",".");
	}
}
...
else
{
	...
	$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' 
	AND (situacao!='SAIDA_DIRETA' OR situacao IS NULL) AND cod_produto='$aux_bp_geral[0]' AND filial='$filial'"));
	$soma_quant_print = number_format($soma_quant_produto[0],2,",",".");
	}
	...
	$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' 
	AND situacao='SAIDA_DIRETA' AND cod_produto='$aux_bp_geral[0]' AND filial='$filial'"));
	$soma_quant_print = number_format($soma_quant_produto[0],2,",",".");
	}
	...
	{
	$soma_quant_produto = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' 
	AND movimentacao='SAIDA' AND data='$data_inicial' AND situacao_romaneio='$status_romaneio' AND cod_produto='$aux_bp_geral[0]' 
	AND filial='$filial'"));
	$soma_quant_print = number_format($soma_quant_produto[0],2,",",".");
	}
}
