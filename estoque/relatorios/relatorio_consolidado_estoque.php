...
$soma_entrada_residuo_pimenta_jaguare = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='11' AND filial='JAGUARE'"));
...
$soma_saida_residuo_pimenta_jaguare = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='11' AND filial='JAGUARE'"));
...
$quant_res_pimenta_jaguare = ($soma_entrada_residuo_pimenta_jaguare[0] - $soma_saida_residuo_pimenta_jaguare[0]);
$quant_res_pimenta_jaguare_print = number_format($quant_res_pimenta_jaguare,2,",",".");
...
$soma_entrada_residuo_pimenta_castanhal = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='11' AND filial='CASTANHAL'"));
...
$soma_saida_residuo_pimenta_castanhal = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='11' AND filial='CASTANHAL'"));
...
$quant_res_pimenta_castanhal = ($soma_entrada_residuo_pimenta_castanhal[0] - $soma_saida_residuo_pimenta_castanhal[0]);
$quant_res_pimenta_castanhal_print = number_format($quant_res_pimenta_castanhal,2,",",".");
...
// ===== ITABELA ===========================================================
$soma_entrada_cafe_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='2' AND filial='ITABELA'"));
$soma_entrada_pimenta_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='3' AND filial='ITABELA'"));
$soma_entrada_cacau_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='4' AND filial='ITABELA'"));
$soma_entrada_cravo_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='5' AND filial='ITABELA'"));
$soma_entrada_cafe_arabica_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='10' AND filial='ITABELA'"));
$soma_entrada_residuo_cacau_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='ENTRADA' AND cod_produto='9' AND filial='ITABELA'"));


$soma_saida_cafe_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='2' AND filial='ITABELA'"));
$soma_saida_pimenta_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='3' AND filial='ITABELA'"));
$soma_saida_cacau_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='4' AND filial='ITABELA'"));
$soma_saida_cravo_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='5' AND filial='ITABELA'"));
$soma_saida_cafe_arabica_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='10' AND filial='ITABELA'"));
$soma_saida_residuo_cacau_itabela = mysqli_fetch_row(mysqli_query ($conexao, "SELECT SUM(quantidade) FROM estoque WHERE estado_registro!='EXCLUIDO' AND movimentacao='SAIDA' AND cod_produto='9' AND filial='ITABELA'"));


$quant_cafe_itabela = ($soma_entrada_cafe_itabela[0] - $soma_saida_cafe_itabela[0]);
$quant_cafe_itabela_convert = ($quant_cafe_itabela / 60);
$quant_cafe_itabela_print = number_format($quant_cafe_itabela_convert,2,",",".");
$quant_pimenta_itabela = ($soma_entrada_pimenta_itabela[0] - $soma_saida_pimenta_itabela[0]);
$quant_pimenta_itabela_print = number_format($quant_pimenta_itabela,2,",",".");
$quant_cacau_itabela = ($soma_entrada_cacau_itabela[0] - $soma_saida_cacau_itabela[0]);
$quant_cacau_itabela_print = number_format($quant_cacau_itabela,2,",",".");
$quant_cravo_itabela = ($soma_entrada_cravo_itabela[0] - $soma_saida_cravo_itabela[0]);
$quant_cravo_itabela_print = number_format($quant_cravo_itabela,2,",",".");
$quant_cafe_arabica_itabela = ($soma_entrada_cafe_arabica_itabela[0] - $soma_saida_cafe_arabica_itabela[0]);
$quant_cafe_arabica_itabela_convert = ($quant_cafe_arabica_itabela / 60);
$quant_cafe_arabica_itabela_print = number_format($quant_cafe_arabica_itabela_convert,2,",",".");
...
// ===== TOTAL ===========================================================
$quant_cafe_total = ($quant_cafe_linhares + $quant_cafe_jaguare + $quant_cafe_castanhal + $quant_cafe_altamira + $quant_cafe_itabela + $quant_cafe_sao_mateus + $quant_cafe_varginha + $quant_cafe_linhares_polo);
$quant_cafe_total_convert = ($quant_cafe_total / 60);
$quant_cafe_total_print = number_format($quant_cafe_total_convert,2,",",".");
$quant_pimenta_total = ($quant_pimenta_linhares + $quant_pimenta_jaguare + $quant_pimenta_castanhal + $quant_pimenta_altamira + $quant_pimenta_itabela + $quant_pimenta_sao_mateus + $quant_pimenta_varginha + $quant_pimenta_linhares_polo);
$quant_pimenta_total_print = number_format($quant_pimenta_total,2,",",".");
$quant_cacau_total = ($quant_cacau_linhares + $quant_cacau_jaguare + $quant_cacau_castanhal + $quant_cacau_altamira + $quant_cacau_itabela + $quant_cacau_sao_mateus + $quant_cacau_varginha + $quant_cacau_linhares_polo);
$quant_cacau_total_print = number_format($quant_cacau_total,2,",",".");
$quant_cravo_total = ($quant_cravo_linhares + $quant_cravo_jaguare + $quant_cravo_castanhal + $quant_cravo_altamira + $quant_cravo_itabela + $quant_cravo_sao_mateus + $quant_cravo_varginha + $quant_cravo_linhares_polo);
$quant_cravo_total_print = number_format($quant_cravo_total,2,",",".");
$quant_cafe_arabica_total = ($quant_cafe_arabica_linhares + $quant_cafe_arabica_jaguare + $quant_cafe_arabica_castanhal + $quant_cafe_arabica_altamira + $quant_cafe_arabica_itabela + $quant_cafe_arabica_sao_mateus + $quant_cafe_arabica_varginha + $quant_cafe_arabica_linhares_polo);
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_cafe_itabela_print Sc"; ?></div>
    </div>
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_pimenta_itabela_print Kg"; ?></div>
    </div>
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_res_pimenta_jaguare_print Kg"; ?></div>
    </div>

    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_res_pimenta_castanhal_print Kg"; ?></div>
    </div>
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_cacau_itabela_print Kg"; ?></div>
    </div>
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_cravo_itabela_print Kg"; ?></div>
    </div>
...
<div id='centro' style='height:22px; width:1220px; border:0px solid #000; margin-top:8px; float:left; margin-left:10px; border-radius:2px; background-color:#EEE' align='center'>
    ...
    <div id='centro' style='width:122px; float:left; height:22px; margin-left:10px; border:0px solid #999'>
    <div style='width:122px; float:left; margin-top:4px; font-size:12px; color:#003466; text-align:center'>
    <?php echo "$quant_cafe_arabica_itabela_print Sc"; ?></div>
    </div>
