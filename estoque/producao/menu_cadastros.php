...
$pagina = 'menu_cadastros';
$titulo = 'Cadastros - Produ&ccedil;&atilde;o';
$modulo = 'estoque';
$menu = 'movimentacao';
// ================================================================================================================
...
<div style="width:1250px; height:315px; margin:auto; font-size:14px">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/producao/cadastro_sacaria.php">
            &#8226; Cadastro de Sacaria</a>
			</div>
		</div>
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
 <!--			<a href="<?php // echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/saida_relatorio_numero.php">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/producao/cadastro_armazem.php">
            &#8226; Cadastro de Armaz&eacute;m</a>
			</div>
		</div>
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
<!--			<a href="<?php // echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/saida_relatorio_produto.php">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/producao/cadastro_lote.php">
            &#8226; Cadastro de Lotes</a>
			</div>
		</div>
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
<!--			<a href="<?php // echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/saida_relatorio_fornecedor_seleciona.php">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/producao/cadastro_servico.php">
            &#8226; Cadastro de Servi&ccedil;os</a>
			</div>
		</div>
...
<!--			<a href="<?php // echo"$servidor/$diretorio_servidor"; ?>/estoque/saida/relatorio_romaneios_excluidos.php">
	...
	<div id="centro" style="height:40px; width:1240px; border:0px solid #000; float:left">
		...
		<div id="geral" style="width:465px; height:38px; float:left; border:0px solid #999">
			<div class="link">
			<a href="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/producao/cadastro_tipo.php">
            &#8226; Cadastro de Tipo</a>
			</div>
		</div>
