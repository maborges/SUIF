...
$pagina = 'index_producao';
$titulo = 'Estoque - Ordem de Produ&ccedil;&atilde;o';
$modulo = 'estoque';
$menu = 'movimentacao';
// ================================================================================================================
...
<div class="ct_topo_1">
    ...
    Ordem de Produ&ccedil;&atilde;o
    </div>
...
<div class="pqa">
    ...
    <form action="<?php echo"$servidor/$diretorio_servidor"; ?>/estoque/entrada/entrada_relatorio_produto.php" method="post" />
	...
	<select class="pqa_select" name="cod_produto_form" onkeydown="if (getKey(event) == 13) return false;" style="width:140px" />
    ...
    <select class="pqa_select" name="situacao_romaneio_form" onkeydown="if (getKey(event) == 13) return false;" style="width:85px" />
    <?php
    if ($situacao_romaneio_form == "GERAL")
    {echo "<option value='GERAL' selected='selected'>(GERAL)</option>";}
    else
    {echo "<option value='GERAL'>(GERAL)</option>";}

    if ($situacao_romaneio_form == "EM_ABERTO")
    {echo "<option value='EM_ABERTO' selected='selected'>Em Aberto</option>";}
    else
    {echo "<option value='EM_ABERTO'>Em Aberto</option>";}

    if ($situacao_romaneio_form == "FECHADO")
